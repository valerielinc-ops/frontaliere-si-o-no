...
const WeeklyFact: React.FC = () => {
  ...
  if (factText === factKey) return <div className="h-[34px]" />;
  ...
  return (
    <div className="flex items-center gap-2 h-[34px] bg-amber-50/80 dark:bg-amber-900/15 backdrop-blur-sm rounded-xl border border-amber-200/60 dark:border-amber-800/30 px-3 text-xs">
      ...
      <button
        onClick={handleShare}
        className="flex-shrink-0 p-0.5 rounded hover:bg-amber-100 dark:hover:bg-amber-800/40 text-amber-500 hover:text-amber-700 dark:hover:text-amber-300 transition-colors"
