...
const CATEGORY_COLORS: Record<string, string> = {
  ...
  lavoro: 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400',
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex flex-wrap items-center gap-2 mt-4">
                  ...
                  {selectedQuestion.tags.map(tag => (
                    <span key={tag} className="inline-flex items-center gap-0.5 px-1.5 py-0.5 bg-slate-100 dark:bg-slate-700 text-slate-500 dark:text-slate-400 rounded text-xs">
                ...
                <div key={answer.id} className={`bg-white dark:bg-slate-800 rounded-xl border p-4 ${
                  ...
                  <div className="flex items-start gap-3">
                    <div className="flex flex-col items-center gap-1">
                      ...
                      <span className="text-xs font-bold text-slate-500 dark:text-slate-400">{answer.upvotes}</span>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl border border-violet-200 dark:border-violet-800 p-5 space-y-3">
          ...
          <div className="flex justify-end gap-2">
            <button
              ...
              className="px-4 py-2 text-sm font-bold text-slate-500 dark:text-slate-400 hover:text-slate-700 transition-colors"
            >
