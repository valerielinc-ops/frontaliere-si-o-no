...
import { useAuth, getAuthEmail, eagerAuth, promptOneTap, cancelOneTap } from '@/services/authService';
import {
            ...
            {!user && (
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 min-h-[40px] grid grid-cols-[20px_1fr_20px] items-center px-4 py-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl text-white/90 text-xs font-semibold hover:bg-white/20 transition-colors"
                >
