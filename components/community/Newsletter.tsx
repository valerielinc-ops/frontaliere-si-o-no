...
const Newsletter: React.FC<NewsletterProps> = ({ compact = false }) => {
 ...
 className="w-full inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-lg bg-[#0A66C2] hover:bg-[#004182] text-on-accent text-sm font-semibold transition-colors"
 >
