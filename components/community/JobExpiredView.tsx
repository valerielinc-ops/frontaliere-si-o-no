    ...
    <div className="space-y-5 max-w-2xl mx-auto">
      ...
      <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/60 p-5 text-center space-y-3">
        ...
        {linkedInAvailable && (
          <button
            type="button"
            onClick={() => { saveAuthJobContext({ slug: job.slug, company: job.company, location: job.location || job.addressLocality, category: job.sector }); signInWithLinkedIn(listingPath); }}
