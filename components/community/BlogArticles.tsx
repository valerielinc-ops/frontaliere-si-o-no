...
function BlogArticles({
 ...
 {idx === 2 && (
 <Suspense fallback={<div style={{ ['--ad-mh']: `${AD_SLOTS.JOBLIST_END_MULTIPLEX.placeholderMinHeight}px` } as CSSProperties} className="sm:col-span-2 lg:col-span-3 min-h-[var(--ad-mh)] [contain:content]" />}>
 <AdSenseBanner
