    ...
    if (!hasAccess) {
      ...
      return (
        <div className="space-y-5">
          ...
          <div className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-5">
            ...
            {descriptionPreview && (
              <div className="relative mt-4 w-full min-h-[132px] overflow-hidden rounded-lg sm:min-h-[148px]">
                ...
                {/* Desktop: CTA button that scrolls to gate below */}
                {!isMobile && (
                  <button
                    type="button"
                    onClick={() => {
                    ...
                    className="absolute inset-0 flex flex-col items-center justify-center gap-2 px-4 py-5 text-center cursor-pointer group"
            ...
            {/* Mobile: auth form embedded directly after blurred preview (no extra click) */}
            {isMobile && (
              <div id="job-auth-gate-mobile" className="mt-3 rounded-2xl border border-indigo-200 dark:border-indigo-800 bg-gradient-to-br from-indigo-50 to-blue-50 dark:from-indigo-950/30 dark:to-blue-950/20 p-5">
                <p className="text-sm font-bold text-slate-900 dark:text-white mb-3">{t('jobBoard.gate.title')}</p>
                <div className="space-y-3">
                  <div className="space-y-2">
                    <div ref={isMobile ? inlineGoogleButtonRef : undefined} className="flex min-h-[44px] w-full items-center justify-center overflow-hidden rounded-xl" />
          ...
          {/* Auth gate inline — Google + Email (desktop only, mobile uses embedded version above) */}
          <div id="job-auth-gate" className={`rounded-2xl border border-indigo-200 dark:border-indigo-800 bg-gradient-to-br from-indigo-50 to-blue-50 dark:from-indigo-950/30 dark:to-blue-950/20 p-6 ${isMobile ? 'hidden' : ''}`}>
            ...
            <div className="space-y-3 mt-4">
              <div className="space-y-2">
                <div ref={isMobile ? undefined : inlineGoogleButtonRef} className="flex min-h-[44px] w-full items-center justify-center overflow-hidden rounded-xl" />
                {!inlineGoogleButtonReady && (
                  <button
                    type="button"
                    onClick={() => {
