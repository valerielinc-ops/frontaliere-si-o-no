...
const ALL_TOOLS: ToolDef[] = [
 { id: 'calculator', icon: '🧮', slug: '/calcola-stipendio', tab: 'calculator', subTab: 'calculator', titleKey: 'toolOfWeek.tools.calculator', descKey: 'toolOfWeek.tools.calculatorDesc', color: 'from-accent-strong to-accent-strong' },
 ...
 { id: 'pension', icon: '🏦', slug: '/tasse-e-pensione/calcola-previdenza/', tab: 'fisco', subTab: 'pension', titleKey: 'toolOfWeek.tools.pension', descKey: 'toolOfWeek.tools.pensionDesc', color: 'from-info-strong to-info-strong' },
 { id: 'permit-quiz', icon: '❓', slug: '/quiz-permesso-b-o-g', tab: 'permit-quiz', titleKey: 'toolOfWeek.tools.permitQuiz', descKey: 'toolOfWeek.tools.permitQuizDesc', color: 'from-info-strong to-info-strong' },
 { id: 'tredicesima', icon: '🎁', slug: '/calcolo-tredicesima-frontaliere', tab: 'tredicesima', titleKey: 'toolOfWeek.tools.tredicesima', descKey: 'toolOfWeek.tools.tredicesimalDesc', color: 'from-warning-strong to-warning-strong' },
 ...
 { id: 'tax-return', icon: '📋', slug: '/tasse-e-pensione/dichiarazione-redditi/', tab: 'fisco', subTab: 'tax-return', titleKey: 'toolOfWeek.tools.taxReturn', descKey: 'toolOfWeek.tools.taxReturnDesc', color: 'from-surface-alt0 to-surface-inverted' },
 { id: 'banks', icon: '🏧', slug: '/compara-servizi/confronta-banche/', tab: 'confronti', subTab: 'banks', titleKey: 'toolOfWeek.tools.banks', descKey: 'toolOfWeek.tools.banksDesc', color: 'from-info-strong to-success-strong' },
 { id: 'payslip', icon: '💰', slug: '/calcola-stipendio/simula-busta-paga/', tab: 'calculator', subTab: 'payslip', titleKey: 'toolOfWeek.tools.payslip', descKey: 'toolOfWeek.tools.payslipDesc', color: 'from-success-strong to-success-strong' },
];
...
const ToolOfTheWeek: React.FC<ToolOfTheWeekProps> = ({ compact = false, onNavigate }) => {
 ...
 className="flex-1 flex items-center justify-center gap-1 text-xs font-medium px-3 py-1.5 bg-accent hover:bg-accent-hover text-on-accent rounded-lg transition-colors"
 ...
 className="p-1.5 bg-success-strong hover:bg-success-strong-hover text-on-accent rounded-lg transition-colors"
 aria-label="WhatsApp"
 >
 ...
 className="p-1.5 bg-surface-muted hover:bg-surface-muted-hover text-on-accent rounded-lg transition-colors"
 ...
 <button
 onClick={handleNavigate}
 className="mt-4 w-full flex items-center justify-center gap-2 px-4 py-3 bg-accent hover:bg-accent-hover text-on-accent font-semibold rounded-xl transition-colors"
 aria-label={t('toolOfWeek.tryIt')}
 >
 {t('toolOfWeek.tryIt')}
 <ArrowRight size={18} />
 ...
 className="flex items-center gap-2 px-4 py-2 bg-info-strong hover:bg-info-strong-hover text-on-accent text-sm font-medium rounded-xl transition-colors"
 ...
 className="flex items-center gap-2 px-4 py-2 bg-accent hover:bg-accent-hover text-on-accent text-sm font-medium rounded-xl transition-colors"
 aria-label="Facebook"
 >
 <Facebook size={16} />
 Facebook
