...
const NewsletterPopup: React.FC = () => {
 ...
 className="text-xs font-medium text-info hover:text-teal-700 dark:hover:text-teal-300 underline underline-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
 >
 ...
 className="mt-4 px-6 py-2 text-sm font-medium text-info hover:bg-teal-50 dark:hover:bg-teal-950/30 rounded-xl transition-colors"
 >
 ...
 className="w-full grid grid-cols-[20px_1fr_20px] items-center py-2.5 px-4 border border-edge rounded-xl text-sm font-semibold text-strong bg-surface hover:bg-slate-100 dark:hover:bg-slate-600 transition-colors shadow-sm"
 >
 ...
 className="w-full px-4 py-3 bg-surface-alt border border-edge rounded-xl focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 text-strong"
 />
 </div>
