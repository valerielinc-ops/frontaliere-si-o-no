...
const NewsletterPopup: React.FC = () => {
 ...
 className="mt-4 px-6 py-2 text-sm font-medium text-info hover:bg-teal-50 rounded-xl transition-colors"
 >
 ...
 className="w-full grid grid-cols-[20px_1fr_20px] items-center py-2.5 px-4 border border-edge rounded-xl text-sm font-semibold text-strong bg-surface hover:bg-slate-100 transition-colors shadow-sm"
 >
