...
const ParentalLeaveCalculator: React.FC<ParentalLeaveProps> = ({ userProfile }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-sm">
          <div className="bg-blue-50 dark:bg-blue-950/30 rounded-lg p-3">
            <p className="text-xs text-blue-600 dark:text-blue-400 font-bold uppercase">AVS/AHV</p>
            <p className="text-slate-700 dark:text-slate-300">{t('leave.lppAvs')}</p>
          </div>
          <div className="bg-blue-50 dark:bg-blue-950/30 rounded-lg p-3">
            <p className="text-xs text-blue-600 dark:text-blue-400 font-bold uppercase">LPP/BVG</p>
            <p className="text-slate-700 dark:text-slate-300">{t('leave.lppBvg')}</p>
          </div>
          <div className="bg-blue-50 dark:bg-blue-950/30 rounded-lg p-3">
            <p className="text-xs text-blue-600 dark:text-blue-400 font-bold uppercase">INPS</p>
            <p className="text-slate-700 dark:text-slate-300">{t('leave.lppInps')}</p>
          </div>
        </div>
      </div>
      ...
      {leaveType === 'maternity' && (
        <div className="bg-green-50 dark:bg-green-950/30 rounded-2xl border border-green-200 dark:border-green-800 p-5">
          ...
          <div className="space-y-3">
            {[1, 2, 3, 4, 5].map((step) => (
              <div key={step} className="flex gap-3">
                <div className="w-7 h-7 rounded-full bg-green-200 dark:bg-green-800 flex items-center justify-center text-xs font-bold text-green-800 dark:text-green-200 shrink-0">
                  {step}
                </div>
                <div>
