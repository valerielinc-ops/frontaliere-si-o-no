  ...
  return (
    <div className="space-y-4 pb-3">
      ...
      {result && !showFullResults && !sheetOpen && (
        <button
          onClick={openSheet}
          className="w-full flex items-center justify-center gap-2 py-2 text-xs font-semibold text-slate-500 dark:text-slate-500 hover:text-slate-700 dark:hover:text-slate-400 transition-colors"
        >
          <Settings2 size={12} />
