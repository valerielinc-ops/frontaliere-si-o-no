    ...
    if (this.state.hasError) {
      return (
        <div className="min-h-[50vh] flex flex-col items-center justify-center p-6 text-center">
          ...
          <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100 mb-2">Ops, qualcosa è andato storto.</h2>
          <p className="text-slate-500 dark:text-slate-400 max-w-md mb-6">
            Si è verificato un errore imprevisto nel calcolo. Abbiamo inviato una segnalazione automatica al team di sviluppo.
          </p>
          <button
