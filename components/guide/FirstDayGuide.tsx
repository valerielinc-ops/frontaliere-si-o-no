...
const CATEGORY_COLORS: Record<string, { bg: string; text: string; border: string }> = {
 ...
 health: { bg: 'bg-danger-subtle', text: 'text-danger', border: 'border-danger-border' },
...
const FirstDayGuide: React.FC = () => {
 ...
 className="inline-flex items-center gap-1 text-xs px-3 py-1.5 bg-neutral-subtle text-neutral rounded-lg hover:bg-neutral-subtle transition-colors font-bold border border-neutral-border"
 >
