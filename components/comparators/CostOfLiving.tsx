      ...
      <div className="flex justify-center">
        <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-1 inline-flex">
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm font-bold transition-all ${!showAnnual ? 'bg-amber-700 text-white' : 'text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700'}`}
          >
