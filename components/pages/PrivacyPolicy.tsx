      ...
      <div className="space-y-6">
        ...
        <div className="bg-surface rounded-[6px] border border-edge p-4 sm:p-6 shadow-stripe-sm">
          <h2 className="text-xl font-medium text-heading mb-4 flex items-center gap-3">
            <Database className="text-green-600 dark:text-green-400 flex-shrink-0" size={22} />
            Raccolta e Utilizzo dei Dati
          </h2>
          <div className="space-y-3 text-subtle">
            <div className="flex items-start gap-3 bg-green-50 dark:bg-green-900/20 p-4 rounded-[6px] border border-green-200 dark:border-green-800">
              <CheckCircle2 className="text-green-600 dark:text-green-400 flex-shrink-0 mt-0.5" size={20} />
              <div>
                <p className="font-bold text-green-800 dark:text-green-300 mb-1">ZERO Raccolta Dati dal Simulatore Fiscale</p>
                <p className="text-sm">
        ...
        <div className="bg-surface rounded-[6px] border border-edge p-4 sm:p-6 shadow-stripe-sm">
          ...
          <div className="space-y-3 text-subtle">
            ...
            <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-[6px] border border-green-200 dark:border-green-800 mt-4">
