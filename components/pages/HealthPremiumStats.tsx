      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl p-5 border border-slate-200 dark:border-slate-700 shadow-sm">
              ...
              {displayed.map((c, i) => {
                ...
                return (
                  <tr key={c.municipality} className="border-b border-slate-100 dark:border-slate-700/50 hover:bg-slate-50 dark:hover:bg-slate-700/30">
                    ...
                    <td className="py-2 px-2 text-right text-slate-500">{c.numInsurers}</td>
                  </tr>
                );
              })}
            </tbody>
        ...
        {filtered.length > 50 && !showAll && (
          <button
            ...
            className="w-full mt-4 py-2 text-xs font-bold text-rose-600 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-950/20 rounded-lg transition-colors"
          >
