...
function ActionLink(props: { label: string; route: Parameters<typeof buildPath>[0]; locale: Locale }) {
 ...
 className="inline-flex items-center rounded-full border border-stripe-200 bg-stripe-50 px-3 py-1.5 text-xs font-bold text-stripe-700 no-underline hover:border-accent-border bg-accent-subtle text-accent hover:border-accent-border"
 onClick={(event) => {
...
function LeaderBlock(props: {
 ...
 return (
 <div className="rounded-3xl border border-slate-100 bg-surface p-5 shadow-sm border-edge">
