...
const UserProfile: React.FC = () => {
 ...
 className="w-full flex items-center justify-center gap-3 px-6 py-3.5 bg-brand-linkedin hover:bg-brand-linkedin-hover border-2 border-brand-linkedin hover:border-brand-linkedin-hover rounded-2xl hover:shadow-lg transition-[color,background-color,border-color,box-shadow] text-on-accent font-semibold"
 >
 ...
 className="w-full flex items-center justify-center gap-3 px-6 py-3.5 bg-brand-facebook border-2 border-brand-facebook rounded-2xl hover:bg-brand-facebook-hover hover:shadow-lg transition-[color,background-color,box-shadow] group"
 >
 ...
 */}
 ...
 className="flex flex-col items-center gap-1 p-3 bg-surface rounded-xl border border-edge hover:border-info-border transition-[border-color] cursor-pointer"
 >
 ...
 {user && (() => {
 const profileEmail = getAuthEmail(user);
