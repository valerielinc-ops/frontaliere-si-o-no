...
const COPY: Record<Locale, EmployerInsightsCopy> = {
  it: {
    ...
    periodLabel: 'Periodo', period30: 'Ultimi 30 giorni', period90: 'Ultimi 90 giorni', periodUnavailable: 'Periodo non disponibile', processingLagNotice: 'Il report viene aggiornato ogni giorno, ma Google Analytics può impiegare fino a 48 ore per completare i dati. Per questo il periodo termina all’ultimo giorno completo disponibile.',
  ...
  en: {
    ...
    periodLabel: 'Period', period30: 'Last 30 days', period90: 'Last 90 days', periodUnavailable: 'Period unavailable', processingLagNotice: 'The report refreshes daily, but Google Analytics can take up to 48 hours to finish processing. That is why the period ends on the latest complete day available.', sourceUnavailable: 'Source unavailable', updated: (date) => `Updated ${date}`,
  ...
  de: {
    ...
    periodLabel: 'Zeitraum', period30: 'Letzte 30 Tage', period90: 'Letzte 90 Tage', periodUnavailable: 'Zeitraum nicht verfügbar', processingLagNotice: 'Der Bericht wird täglich aktualisiert, aber Google Analytics kann bis zu 48 Stunden für die Verarbeitung benötigen. Deshalb endet der Zeitraum am letzten vollständig verfügbaren Tag.', sourceUnavailable: 'Quelle nicht verfügbar', updated: (date) => `Aktualisiert am ${date}`,
  ...
  fr: {
    ...
    periodLabel: 'Période', period30: '30 derniers jours', period90: '90 derniers jours', periodUnavailable: 'Période indisponible', processingLagNotice: 'Le rapport est actualisé chaque jour, mais Google Analytics peut nécessiter jusqu’à 48 heures pour finaliser les données. La période se termine donc au dernier jour complet disponible.', sourceUnavailable: 'Source indisponible', updated: (date) => `Mis à jour le ${date}`,
...
export function EmployerInsightsReport({ data, locale: localeProp }: { data: EmployerInsights; locale?: Locale }): React.ReactElement {
  ...
  const showProcessingLagNotice = hasAnalyticsProcessingLag(data.source, data.generatedAt, activeRange.window);
