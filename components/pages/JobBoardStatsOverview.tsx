...
const JobBoardStatsOverviewInner: React.FC<{ locale: Locale }> = ({ locale }) => {
 ...
 <div className="rounded-2xl border border-accent-border bg-accent-subtle p-4">
 ...
 <div className="rounded-2xl border border-edge bg-surface-alt p-4">
 ...
 <div className="flex flex-col items-start gap-3 self-start rounded-2xl border border-edge bg-surface-alt p-4">
 <div className="text-xs font-bold uppercase tracking-[0.16em] text-muted">
 {copy.updatedAt}
 </div>
