  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-6 space-y-10">
      ...
      <header className="space-y-3">
        ...
        <p className="text-xs text-slate-500 dark:text-slate-500 italic">{c.disclaimer}</p>
      </header>
      ...
      <section className="space-y-4">
        ...
        <p className="text-xs text-slate-500 dark:text-slate-500 italic">{c.exampleNote}</p>
      </section>
