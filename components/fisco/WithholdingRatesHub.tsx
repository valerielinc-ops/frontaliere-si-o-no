...
export default function WithholdingRatesHub() {
 ...
 <thead>
 <tr>
 <th className="bg-surface-raised px-4 py-3 text-left text-xs font-bold uppercase tracking-[0.12em] text-subtle">{copy.matrixColumns.scenario}</th>
 <th className="bg-surface-raised px-4 py-3 text-left text-xs font-bold uppercase tracking-[0.12em] text-subtle">{copy.matrixColumns.who}</th>
 <th className="bg-surface-raised px-4 py-3 text-left text-xs font-bold uppercase tracking-[0.12em] text-subtle">{copy.matrixColumns.low}</th>
 <th className="bg-surface-raised px-4 py-3 text-left text-xs font-bold uppercase tracking-[0.12em] text-subtle">{copy.matrixColumns.medium}</th>
 <th className="bg-surface-raised px-4 py-3 text-left text-xs font-bold uppercase tracking-[0.12em] text-subtle">{copy.matrixColumns.high}</th>
 </tr>
 </thead>
 <tbody>
 {SCENARIOS.map((scenario) => (
