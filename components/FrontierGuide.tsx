...
const FrontierGuide: React.FC = () => {
  ...
  const lombardyMunicipalities: Municipality[] = [
    ...
    { name: "Faloppio", province: "Como", distance: 4.5, borderCrossing: "Chiasso-Brogeda", population: 4200, type: 'both', lat: 45.8322, lng: 9.0286 },
    ...
    { name: "Carate Urio", province: "Como", distance: 10, borderCrossing: "Chiasso", population: 1300, type: 'both', lat: 45.8194, lng: 9.1339 },
