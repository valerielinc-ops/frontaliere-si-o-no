  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="text-sm font-semibold text-slate-700 dark:text-slate-200 flex-1 truncate">
        ...
        <Info className="w-3.5 h-3.5 text-slate-400 dark:text-slate-500 shrink-0 group-hover:text-slate-600 dark:group-hover:text-slate-300 transition-colors" aria-hidden="true" />
        {expanded
          ? <ChevronUp className="w-4 h-4 text-slate-400 dark:text-slate-500 shrink-0" aria-hidden="true" />
