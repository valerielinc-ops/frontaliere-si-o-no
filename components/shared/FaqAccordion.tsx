        ...
        {items.map((item, i) => (
          <div key={i} className="border border-edge rounded-lg overflow-hidden">
            <button
              ...
              className="w-full flex items-center justify-between px-4 py-3 text-left bg-surface hover:bg-surface-raised/50 transition-colors"
            ...
            >
              <div className="px-4 py-3 text-sm text-subtle bg-surface-alt/30 border-t border-edge">
                {item.answer}
              </div>
            </div>
          </div>
