...
const LeadMagnetCTA: React.FC<LeadMagnetCTAProps> = ({
 ...
 {linkedInAvailable && (
 <button type="button" onClick={() => signInWithLinkedIn()} className="w-full inline-flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-lg bg-brand-linkedin hover:bg-brand-linkedin-hover text-on-accent text-xs font-semibold transition-colors">
