    ...
    return (
      <div className={`relative mt-4 p-4 bg-gradient-to-r ${colors.gradient} border ${colors.border} rounded-xl`}>
        ...
        <div className="flex gap-2">
          ...
          {linkedInAvailable && (
            <button type="button" onClick={() => signInWithLinkedIn()} className="flex-1 inline-flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#0A66C2] hover:bg-[#004182] text-white text-xs font-semibold transition-colors">
