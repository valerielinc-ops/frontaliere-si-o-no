...
const DonationBanner: React.FC<DonationBannerProps> = ({ variant = 'inline' }) => {
 ...
 if (variant === 'inline') {
 return (
 <div className="flex items-center gap-3 p-3 bg-warning-subtle/50 rounded-xl border border-warning-border">
 ...
 onClick={handleClick}
 className="flex-shrink-0 inline-flex items-center gap-1 px-3 py-1.5 text-xs font-medium text-warning bg-warning-subtle hover:bg-warning-subtle rounded-lg transition-colors border border-warning-border"
 >
