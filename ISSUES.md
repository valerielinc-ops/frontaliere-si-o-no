...
**Meccanismo comune ai tre pre-flight 0/0.5/0.75 (zero-Claude, pre-Claude)**: al trigger rimuove `agent:fix`, posta commento col marker, imposta l'output guard, salta gli step Claude (`if:`).
