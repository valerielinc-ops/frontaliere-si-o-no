...
function mapEmploymentTypeLd(value, contractLabel = '', title = '') {
  ...
  if (/\b(lehrling|lernend|apprenti|apprendist|praktik|stages?(?=\W|$)|stagiair)/.test(t)) return 'internship';
  return 'full-time';
}

function detectExperienceLevel(title = '') {
  const t = title.toLowerCase();
  if (/\b(lehrling|lernend\w*|apprenti\w*|apprendist\w*|stages?(?=\W|$)|stagiair\w*|praktik\w*|intern(?:ship)?s?(?=\W|$))/.test(t)) return 'intern';
