...
function detectExperienceLevel(title = '') {
  ...
  if (/\b(praktik|stages?(?=\W|$)|stagiair|intern(?:ship)?s?(?=\W|$)|apprendist|lehrling|lernend|apprenti|hochschulpraktik)/.test(t)) return 'intern';
...
function detectEmploymentType(title = '', jsonLdType = '') {
  ...
  if (/\b(praktik|intern(?:ship)?s?(?=\W|$)|stages?(?=\W|$))/.test(t)) return 'INTERN';
  return 'OTHER';
}
