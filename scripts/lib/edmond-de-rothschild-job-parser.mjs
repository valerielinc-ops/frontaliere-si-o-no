...
function detectExperienceLevel(title = '') {
  const t = normalize(title);
  if (/\b(stagiaire|stages?(?=\W|$)|intern(?:ship)?s?(?=\W|$)|apprenti|apprentice|trainee|praktik)/.test(t)) return 'intern';
...
function detectEmploymentType(title = '') {
  ...
  if (/\b(stagiaire|stages?(?=\W|$)|intern(?:ship)?s?(?=\W|$)|apprenti|apprentice)/.test(t)) return 'INTERN';
