...
export function heuristicTranslateJobTitle(title = '', locale = 'it') {
  ...
  const dictionaries = {
    it: [
      ...
      [/\bMitarbeiter(?:\/in)?\s+Verkauf\b/gi, 'Addetto/a alle vendite'],
      [/\bMitarbeiter(?:\/in)?\s+Logistik\b/gi, 'Addetto/a alla logistica'],
      [/\bMitarbeiter(?:\/in)?\s+Produktion\b/gi, 'Addetto/a alla produzione'],
