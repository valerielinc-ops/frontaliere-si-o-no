...
export const SWISS_CANTONS = {
  AG: { code: 'AG', names: ['aargau', 'argovie', 'argovia'] },
  AI: { code: 'AI', names: ['appenzell innerrhoden', 'appenzell rhodes-intérieures', 'appenzello interno'] },
  AR: { code: 'AR', names: ['appenzell ausserrhoden', 'appenzell rhodes-extérieures', 'appenzello esterno'] },
  BE: { code: 'BE', names: ['bern', 'berne', 'berna'] },
  BL: { code: 'BL', names: ['basel-landschaft', 'bâle-campagne', 'basilea campagna'] },
  BS: { code: 'BS', names: ['basel-stadt', 'bâle-ville', 'basilea città', 'basel'] },
  FR: { code: 'FR', names: ['fribourg', 'freiburg', 'friborgo', 'friburgo'] },
  GE: { code: 'GE', names: ['genève', 'geneva', 'genf', 'ginevra'] },
  ...
  JU: { code: 'JU', names: ['jura', 'giura'] },
  LU: { code: 'LU', names: ['luzern', 'lucerne', 'lucerna'] },
  NE: { code: 'NE', names: ['neuchâtel', 'neuchatel', 'neuenburg'] },
  NW: { code: 'NW', names: ['nidwalden', 'nidwald', 'nidvaldo'] },
  OW: { code: 'OW', names: ['obwalden', 'obwald', 'obvaldo'] },
  SG: { code: 'SG', names: ['st. gallen', 'st gallen', 'saint-gall', 'san gallo', 'sankt gallen'] },
  SH: { code: 'SH', names: ['schaffhausen', 'schaffhouse', 'sciaffusa'] },
  SO: { code: 'SO', names: ['solothurn', 'soleure', 'soletta'] },
  SZ: { code: 'SZ', names: ['schwyz', 'svitto'] },
  TG: { code: 'TG', names: ['thurgau', 'thurgovie', 'turgovia'] },
  TI: {
    code: 'TI',
    names: [
      'ticino', 'tessin',
  ...
  UR: { code: 'UR', names: ['uri'] },
  VD: { code: 'VD', names: ['vaud', 'waadt'] },
  VS: { code: 'VS', names: ['valais', 'wallis', 'vallese'] },
  ZG: { code: 'ZG', names: ['zug', 'zoug', 'zugo'] },
  ZH: { code: 'ZH', names: ['zürich', 'zurich', 'zuerich', 'zurigo'] },
};
