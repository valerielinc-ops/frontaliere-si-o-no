...
async function fetchJobListings(runtime = {}) {
  return runUmantisSpecWithEmptyProof(RECRUITINGAPP_1154_KEY, runtime);
}
 ...
 */
export async function fetchAllRecruitingapp1154Jobs(runtime = {}) {
  ...
  if (!listings || listings.length === 0) {
    ...
    return umantisAuthoritativeEmptyOrNull(listings, RECRUITINGAPP_1154_COMPANY_NAME) || [];
  }
