 ...
 *
 * Live source:   https://live.solique.ch/adullam/   (Solique recruiting board)
 ...
 * real server-rendered descriptions. So Solique is now the source of truth and
 * we crawl it directly (the Umantis tenant listing is a stale partial mirror).
 *
