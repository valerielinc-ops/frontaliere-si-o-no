...
function detectExperienceLevel(title = '') {
  const t = normalize(title);
  if (/\b(intern(?:ship)?s?(?=\W|$)|stages?(?=\W|$)|stagiaire|apprenti|apprentice|trainee|graduate)/.test(t)) return 'intern';
...
function detectEmploymentType(timeType = '', title = '') {
  ...
  if (/\b(intern(?:ship)?s?(?=\W|$)|stages?(?=\W|$)|stagiaire|apprenti|apprentice)/.test(t)) return 'INTERN';
  return 'FULL_TIME';
}
