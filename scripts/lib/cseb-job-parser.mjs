...
function detectExperienceLevel(title = '') {
  const t = normalize(title);
  if (/\b(praktik|stages?(?=\W|$)|stagiair|intern(?:ship)?s?(?=\W|$)|apprendist|lehrling|lernend|apprenti|forschungspraktik|famulant|famulatur|unterassistent|lehrstelle|ags|eba|efz)/.test(t)) return 'intern';
