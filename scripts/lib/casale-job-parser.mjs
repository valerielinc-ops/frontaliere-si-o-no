...
export function detectCategory(title = '') {
  ...
  if (/\b(intern(?:ship)?s?(?=\W|$)|apprenti|stages?(?=\W|$)|laborant)/i.test(t)) return 'internship';
...
export function detectExperienceLevel(title = '') {
  if (/\b(intern(?:ship)?s?(?=\W|$)|apprenti|jr\.?|junior|entry|stages?(?=\W|$))/i.test(title)) return 'ENTRY';
