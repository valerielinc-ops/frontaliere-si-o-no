...
function detectExperienceLevel(title = '') {
  ...
  if (/\b(praktik|stages?(?![a-zA-Z0-9_À-ÖØ-öø-ÿ])|intern(?:ship)?s?(?![a-zA-Z0-9_À-ÖØ-öø-ÿ])|apprendist|lehrling|lernend|doktorand|ausbildung|berufsvorbereitungsjahr|bvj|in ausbildung)/.test(t)) return 'intern';
