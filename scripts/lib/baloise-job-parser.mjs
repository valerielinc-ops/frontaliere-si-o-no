 ...
 * canton-gated HQ fallback for a listing without a resolvable address; the
 * live Baloise-workplace listings found so far all resolve their own
 * SO-canton address from `sza_workplace`/`sza_location.zip` and never hit
 * this fallback.
 */
