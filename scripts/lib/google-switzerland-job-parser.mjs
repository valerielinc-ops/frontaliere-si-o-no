...
function detectExperienceLevel(title = '', level = '') {
  ...
  if (/\b(praktik|stages?(?=\W|$)|stagiair|intern(?:ship)?s?(?=\W|$)|apprendist|lehrling|lernend|apprenti|apprenticeship|university grad)/.test(t)) return 'intern';
...
function detectEmploymentType(text = '') {
  ...
  if (/\b(intern(?:ship)?s?(?=\W|$)|apprenticeship|apprendist)/.test(t)) return 'OTHER';
  return 'FULL_TIME';
}
