...
function detectExperienceLevel(title = '') {
  ...
  if (/\b(praktik|stages?(?=\W|$)|stagiair|intern(?:ship)?s?(?=\W|$)|apprendist|lehrling|lernend|apprenti|graduate|trainee)/.test(t)) return 'intern';
...
function detectEmploymentType(text = '') {
  ...
  if (/\b(intern(?:ship)?s?(?=\W|$)|stages?(?=\W|$)|stagiair|praktik|trainee)/.test(t)) return 'INTERN';
