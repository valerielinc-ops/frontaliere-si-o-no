...
// Bare (parenthesis-stripped) form of every "<City> (XX)" BFS entry that
// belongs to canton `cantonCode`, keyed by that canton alone — NOT folded
// into the global token sets above. Registering "küsnacht" globally would
