  ...
  return [
    ...
    buildScheda({
      causa: [
        ...
        "finito: il gate di recency lo ha tenuto. Quale delle tre superfici sia — `cdn-r2`,",
        '`worker-shard`, `apex-pages` — decide il rimedio e NON si assume: la partizione sta in',
        '`scripts/lib/cf-error-surface.mjs` e il triage in `docs/CF-5XX-TRIAGE.md`. Con',
        "`originResponseStatus: 0` l'origin non ha risposto affatto e l'errore e' sintetizzato",
        "da Cloudflare; con uno stato vero e' stato l'origin a restituirlo, e i due rimedi sono",
        'opposti.',
      ],
      fix: [
        'Dipende dalla superficie; non preassegnata qui. | **REPO**: sito | **MODE**: nessun',
        'vincolo di mirror (le cache rule sono possedute da',
