...
async function discoverSwissJobs() {
  ...
  try {
    return await withBrowser(async (page) => {
      ...
      console.log(`🇨🇭 ${swiss.length}/${listings.length} jobs match Switzerland.`);
