export const DEFAULT_EXCHANGE_RATE = 1.096;
...
// Lombardia addizionale regionale IRPEF 2025/2026 — scaglioni per reddito imponibile
export const LOMBARDIA_ADDIZIONALE_REGIONALE = [
 { upTo: 15000, rate: 0.0123 }, // 1.23%
 { upTo: 28000, rate: 0.0158 }, // 1.58%
 { upTo: 50000, rate: 0.0172 }, // 1.72%
 { upTo: Infinity, rate: 0.0173 }, // 1.73%
];
