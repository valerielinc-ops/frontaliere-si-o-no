...
export const calculateDynamicExpenses = (familyMembers: number, target: 'CH' | 'IT') => {
  ...
  if (target === 'CH') {
    return [
      ...
      { label: 'Internet & TV (Billag)', amount: 110, frequency: 'MONTHLY', icon: 'Tv', tooltip: 'Include canone TV obbligatorio (Billag/Serafe).' },
      { label: 'Cellulare Swisscom', amount: familyMembers === 1 ? 45 : Math.round(45 * Math.min(familyMembers, 3) * 0.7), frequency: 'MONTHLY', icon: 'Smartphone' },
    ...
    return [
      ...
      { label: 'Cellulare (Tim/Vodafone)', amount: familyMembers === 1 ? 12 : Math.round(12 * Math.min(familyMembers, 3) * 0.8), frequency: 'MONTHLY', icon: 'Smartphone', tooltip: 'Solo costo SIM (abbonamento voce/dati). Se hai cellulare a rate, aggiungilo come spesa separata.' },
...
export const PRESET_EXPENSES_CH = [
  ...
  { label: 'Internet & TV (Billag)', amount: 110, frequency: 'MONTHLY', icon: 'Tv', tooltip: 'Include canone TV obbligatorio (Billag/Serafe).' },
  { label: 'Cellulare Swisscom', amount: 45, frequency: 'MONTHLY', icon: 'Smartphone' },
...
export const PRESET_EXPENSES_IT = [
  ...
  { label: 'Internet Casa Fibra', amount: 30, frequency: 'MONTHLY', icon: 'Wifi' },
  { label: 'Cellulare (Tim/Vodafone)', amount: 12, frequency: 'MONTHLY', icon: 'Smartphone', tooltip: 'Solo costo SIM (abbonamento voce/dati). Se hai cellulare a rate, aggiungilo come spesa separata.' },
