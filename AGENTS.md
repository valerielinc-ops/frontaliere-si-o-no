...
- Leve frugalità attive:
  ...
  - Concurrency per-issue (`cancel-in-progress: false`) con cap bounded a 5 fixer remoti; routing salta le issue non-OPEN e i claim locali/remoti.
