...
const blogMetaChEn: Record<string, string> = {
  ...
  'blog.article.premi-cassa-malati-svizzera-2026.imageAlt': 'View of Bellinzona with its medieval castles, capital of one of the costlier cantons for health insurance.',
    ...
    'blog.article.acquisto-casa-neuchatel-costi-mutuo.title': 'Buying a house in Neuchâtel: prices and mortgage',
    'blog.article.acquisto-casa-neuchatel-costi-mutuo.excerpt': 'Buying a house in Neuchâtel: calculation of own funds, sustainable mortgage, transfer taxes and notary fees in Switzerland.',
    'blog.article.acquisto-casa-neuchatel-costi-mutuo.imageAlt': 'Modern stone house in Neuchâtel canton with mountains in background',
    ...
    'blog.article.cannabis-farmacia-vendita.title': 'Cannabis: pharmacy sale reduces risks, study',
    'blog.article.cannabis-farmacia-vendita.excerpt': 'The sale of cannabis in pharmacies in Bern, Biel and Lucerne favors less risky consumption, according to a study.',
    'blog.article.cannabis-farmacia-vendita.imageAlt': 'Pharmacy in Switzerland with cannabis sale sign',
    ...
    'blog.article.confederazione-mantiene-aree-thun-difesa.title': 'Confederation wants to maintain Thun areas for army and defense',
    'blog.article.confederazione-mantiene-aree-thun-difesa.excerpt': 'The Confederation will not cede areas in the economic development pole of Thun Nord for exclusively civil uses',
    'blog.article.confederazione-mantiene-aree-thun-difesa.imageAlt': 'Aerial view of Thun with the military training area and surrounding industrial zones',
    'blog.article.disoccupazione-giovani-svizzera-agosto-2023.title': 'Youth unemployment Switzerland: 3.4% in August 2023',
    'blog.article.disoccupazione-giovani-svizzera-agosto-2023.excerpt': 'The Swiss labour market shows solidity, with a seasonal increase of 3.4% among young people in August 2023.',
    'blog.article.disoccupazione-giovani-svizzera-agosto-2023.imageAlt': 'Aerial view of Locarno, Switzerland, with the Ticino landscape in the background, featuring a bustling market square and modern buildings.',
    ...
    'blog.article.aviazione-emissioni-svizzera-2025.title': 'Air traffic and emissions: return to pre-Covid levels',
    'blog.article.aviazione-emissioni-svizzera-2025.excerpt': 'In 2025, Switzerland recorded 1.4 million air movements and 60.5 million passengers. CO2 emissions are growing (+3%). UST confirms the pre-Covid recovery.',
    'blog.article.aviazione-emissioni-svizzera-2025.imageAlt': 'Aerial view of Swiss landscape from commercial aircraft window, cities and lakes visible below during cruise flight.',
    ...
    'blog.article.farmacie-turno-ticino-guida.title': 'Ticino on-duty pharmacies: a guide to sources and coverage',
    'blog.article.farmacie-turno-ticino-guida.excerpt': 'This guide explains where to read Ticino pharmacy duty information and how to interpret regional coverage correctly. 207 Ticino records and 542 records in provinces CO, VA and VB; regional duty verified in the five Ticino areas.',
    'blog.article.farmacie-turno-ticino-guida.imageAlt': 'View of Bellinzona in Ticino',
    'blog.article.farmacie-turno-ticino-guida.seoDescription': 'Ticino and CO/VA/VB pharmacies: verified duty in five Ticino regions, including Locarnese. Not nationwide coverage.',
    'blog.article.farmacie-turno-ticino-guida.ogDescription': 'Ticino and CO/VA/VB pharmacy directories: 207 Ticino records and 542 records in provinces CO, VA and VB; sources, timestamps and limits are explicit.',
    'blog.article.farmacie-ticino-elenco-contatti.title': 'Pharmacies in Ticino: directory and contacts',
    'blog.article.farmacie-ticino-elenco-contatti.excerpt': 'A starting point for finding pharmacies present in the Ticino directory and opening the local records that are available. 207 Ticino records and 542 records in provinces CO, VA and VB; regional duty verified in the five Ticino areas.',
    'blog.article.farmacie-ticino-elenco-contatti.imageAlt': 'Panorama of Lugano in Ticino',
    'blog.article.farmacie-ticino-elenco-contatti.seoDescription': 'Ticino and CO/VA/VB pharmacies: verified duty in five Ticino regions, including Locarnese. Not nationwide coverage.',
    'blog.article.farmacie-ticino-elenco-contatti.ogDescription': 'Ticino and CO/VA/VB pharmacy directories: 207 Ticino records and 542 records in provinces CO, VA and VB; sources, timestamps and limits are explicit.',
    'blog.article.farmacie-confine-italia-como-varese-verbano.title': 'Border pharmacies: Como, Varese and Verbano',
    'blog.article.farmacie-confine-italia-como-varese-verbano.excerpt': 'How to use the Italian border pharmacy catalogue alongside the Ticino directory without turning an address record into an opening promise. 207 Ticino records and 542 records in provinces CO, VA and VB; regional duty verified in the five Ticino areas.',
    'blog.article.farmacie-confine-italia-como-varese-verbano.imageAlt': 'Mendrisiotto landscape near the border',
    'blog.article.farmacie-confine-italia-como-varese-verbano.seoDescription': 'Ticino and CO/VA/VB pharmacies: verified duty in five Ticino regions, including Locarnese. Not nationwide coverage.',
    'blog.article.farmacie-confine-italia-como-varese-verbano.ogDescription': 'Ticino and CO/VA/VB pharmacy directories: 207 Ticino records and 542 records in provinces CO, VA and VB; sources, timestamps and limits are explicit.',
    'blog.article.farmacia-aperta-turno-elenco.title': 'Open or on duty? How to read the pharmacy directory',
    'blog.article.farmacia-aperta-turno-elenco.excerpt': 'The practical difference between finding a pharmacy in a directory, reading published hours and checking OFCT duty information. 207 Ticino records and 542 records in provinces CO, VA and VB; regional duty verified in the five Ticino areas.',
    'blog.article.farmacia-aperta-turno-elenco.imageAlt': 'Castelgrande in Bellinzona, Ticino',
    'blog.article.farmacia-aperta-turno-elenco.seoDescription': 'Ticino and CO/VA/VB pharmacies: verified duty in five Ticino regions, including Locarnese. Not nationwide coverage.',
    ...
    'blog.article.farmacie-turno-svizzera-confine-italiano.excerpt': 'A guide to checking the current source in the right canton, without inventing calendars or turning a link into an opening promise. 207 Ticino records and 542 records in provinces CO, VA and VB; regional duty verified in the five Ticino areas.',
