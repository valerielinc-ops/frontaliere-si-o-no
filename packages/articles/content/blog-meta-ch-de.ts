...
const blogMetaChDe: Record<string, string> = {
  ...
  'blog.article.premi-cassa-malati-svizzera-2026.imageAlt': 'Blick auf Bellinzona mit den mittelalterlichen Burgen, Hauptort eines der teureren Kantone bei der Krankenkasse.',
    ...
    'blog.article.novartis-giornata-nera.title': 'Schwarzer Tag für Novartis: 10% Einbruch',
    'blog.article.novartis-giornata-nera.excerpt': 'Novartis-Aktien stürzen an einem Tag um mehr als 10% ab. Verlorene Kapitalisierung: 24 Mrd. CHF. Zwei Misserfolge in der klinischen Forschung erschüttern den Schweizer Pharmariesen.',
    'blog.article.novartis-giornata-nera.imageAlt': 'Schweizer Handelssaal mit Börsendaten auf Bildschirmen bei Tagesanbruch, der die Bedeutung der Schweizer Finanzmärkte widerspiegelt.',
    ...
    'blog.article.aviazione-emissioni-svizzera-2025.title': 'Luftverkehr und Emissionen: Rückkehr zum Pre-Covid-Niveau',
    'blog.article.aviazione-emissioni-svizzera-2025.excerpt': 'Im Jahr 2025 verzeichnete die Schweiz 1,4 Millionen Flugbewegungen und 60,5 Millionen Passagiere. Die CO2-Emissionen steigen (+3%). USt bestätigt die Pre-Covid-Rückgewinnung.',
    'blog.article.aviazione-emissioni-svizzera-2025.imageAlt': 'Luftaufnahme der Schweizer Landschaft aus Flugzeugfenster, Städte und Seen sichtbar während des Fluges.',
    ...
    'blog.article.alleanza-energia-elettrica-svizzera.title': 'Energieallianz: Schweiz im Zentrum des EU-Netzes',
    'blog.article.alleanza-energia-elettrica-svizzera.excerpt': 'Ein neues Bündnis von Wirtschaftsakteuren unterstützt das Energieabkommen mit der EU. Die Schweiz ist auf Winterimporte angewiesen und exportiert im Sommer.',
    'blog.article.alleanza-energia-elettrica-svizzera.imageAlt': 'Schweizer Stromverteilungszentrum mit Technikern, die die europäische Stromverteilung überwachen',
