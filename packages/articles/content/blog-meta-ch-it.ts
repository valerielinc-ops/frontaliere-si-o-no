...
const blogMetaChIt: Record<string, string> = {
  ...
  'blog.article.premi-cassa-malati-svizzera-2026.imageAlt': 'Panorama di Bellinzona con i castelli medievali, capoluogo di un cantone tra i più cari per la cassa malati.',
    ...
    'blog.article.aprire-attivita-soletta-commercio-costi.title': 'Aprire un\'attività canton Soletta: guida registro e costi',
    'blog.article.aprire-attivita-soletta-commercio-costi.excerpt': 'Come avviare un\'attività nel canton Soletta: forme giuridiche, registrazione commerciale, tassazione cantonale e previdenza obbligatoria (AVS, LPP, LAMal).',
    'blog.article.aprire-attivita-soletta-commercio-costi.imageAlt': 'Ufficio del registro di commercio svizzero con banco accoglienza moderno e linee architettoniche contemporanee',
    'blog.article.avviare-attivita-soletta-guida-completa.title': 'Aprire attività in Soletta: forme giuridiche, costi e procedure',
    'blog.article.avviare-attivita-soletta-guida-completa.excerpt': 'Guida pratica all\'avviamento di un\'impresa nel Cantone di Soletta: scelta della forma giuridica, iscrizione al Registro di commercio, imposte e obblighi assicurativi.',
    'blog.article.avviare-attivita-soletta-guida-completa.imageAlt': 'Veduta di un ufficio amministrativo svizzero, simbolo di procedura di avvio d\'impresa e registro di commercio',
    'blog.article.creare-attivita-soletta-checklist.title': 'Avviare attività a Soletta: costi e procedura',
    'blog.article.creare-attivita-soletta-checklist.excerpt': 'Forma giuridica, iscrizione al registro commercio, tasse cantonali e obblighi previdenziali: la procedura per aprire attività nel canton Soletta.',
    'blog.article.creare-attivita-soletta-checklist.imageAlt': 'Imprenditore che esamina documenti di registrazione commerciale durante l\'avvio di attività nel canton Soletta.',
    ...
    'blog.article.acquisto-casa-neuchatel-costi-mutuo.title': 'Comprare casa a Neuchâtel: prezzi e mutuo ipotecario',
    'blog.article.acquisto-casa-neuchatel-costi-mutuo.excerpt': 'Acquistare casa a Neuchâtel: calcolo dei fondi propri, mutuo ipotecario sostenibile, tasse sui trapassi e spese notarili in Svizzera.',
    'blog.article.acquisto-casa-neuchatel-costi-mutuo.imageAlt': 'Casa moderna in pietra nel Cantone Neuchâtel con montagne sullo sfondo',
    'blog.article.abbonamenti-trasporti-neuchatel-zone.title': 'Abbonamenti trasporti Neuchâtel: zone e tariffe',
    'blog.article.abbonamenti-trasporti-neuchatel-zone.excerpt': 'Scopri come funzionano gli abbonamenti per i trasporti pubblici nel Cantone di Neuchâtel: zone tariffarie, metà-prezzo, GA e sconti per studenti e apprendisti.',
    'blog.article.abbonamenti-trasporti-neuchatel-zone.imageAlt': 'Stazione di trasporto pubblico svizzera con tabelloni orari e zone tariffarie, passeggeri in transito.',
    'blog.article.avs-prestazioni-complementari-appenzello-esterno.title': 'Gestione del primo pilastro AVS nel Cantone di Appenzello Esterno',
    'blog.article.avs-prestazioni-complementari-appenzello-esterno.excerpt': 'Il Cantone di Appenzello Esterno gestisce il primo pilastro AVS tramite una cassa di compensazione cantonale, garantendo le prestazioni ai contribuenti.',
    'blog.article.avs-prestazioni-complementari-appenzello-esterno.imageAlt': 'Castelgrande in Bellinzona, Svizzera',
    ...
    'blog.article.neuchatel-salari-settori-formazione.title': 'Salari e mercato del lavoro Neuchâtel: settori e formazione',
    'blog.article.neuchatel-salari-settori-formazione.excerpt': 'Stipendi, settori che assumono e contratti collettivi nel Cantone di Neuchâtel: come funziona il sistema svizzero di salari per grado di formazione e contributi.',
    'blog.article.neuchatel-salari-settori-formazione.imageAlt': 'Professionista svizzero al lavoro in ufficio con documenti di salario, paesaggio del Cantone di Neuchâtel sullo sfondo',
    ...
    'blog.article.cannabis-farmacia-vendita.title': 'Cannabis: vendita in farmacia riduce rischi, studio',
    'blog.article.cannabis-farmacia-vendita.excerpt': 'La vendita di cannabis nelle farmacie di Berna, Bienne e Lucerna favorisce un consumo meno rischioso, secondo uno studio.',
    'blog.article.cannabis-farmacia-vendita.imageAlt': 'Farmacia in Svizzera con cartello vendita cannabis',
    ...
    'blog.article.volo-swiss-emergenza-medica-zurigo-boston.title': 'Emergenza medica: volo Swiss torna indietro sull\'Atlantico',
    'blog.article.volo-swiss-emergenza-medica-zurigo-boston.excerpt': 'Sabato sera il volo Swiss LX54 partito da Zurigo alla volta di Boston ha dovuto invertire la rotta sopra l’Atlantico e tornare in Svizzera.',
    'blog.article.volo-swiss-emergenza-medica-zurigo-boston.imageAlt': 'Vista aerea di un aereo svizzero sopra l\'Atlantico',
    'blog.article.zurich-hcl-gold-sponsor-2030.title': 'Zurich rinnova con l’HCL: Gold Sponsor fino al 2030',
    'blog.article.zurich-hcl-gold-sponsor-2030.excerpt': 'Zurich Assicurazioni ha rinnovato la sua partnership con l’Hockey Club Lugano fino al 2030, confermandosi Gold Sponsor.',
    'blog.article.zurich-hcl-gold-sponsor-2030.imageAlt': 'Vista panoramica del Lago di Lugano con l\'Hockey Club Lugano e Zurich Assicurazioni',
    'blog.article.action-negozio-20esimo-schattdorf.title': 'Action accelera e apre il 20esimo negozio',
    'blog.article.action-negozio-20esimo-schattdorf.excerpt': 'Action inaugura il suo 20esimo negozio in Svizzera a Schattdorf, Uri, il 17 settembre, con 14 nuove assunzioni locali.',
    'blog.article.action-negozio-20esimo-schattdorf.imageAlt': 'Vista aerea del nuovo negozio Action a Schattdorf, Uri, Svizzera',
    ...
    'blog.article.disoccupazione-giovani-svizzera-agosto-2023.title': 'Disoccupazione giovani Svizzera: 3,4% in agosto 2023',
    'blog.article.disoccupazione-giovani-svizzera-agosto-2023.excerpt': 'Il mercato del lavoro svizzero mostra solidità, con un aumento stagionale di 3,4% tra i giovani in agosto 2023.',
    'blog.article.disoccupazione-giovani-svizzera-agosto-2023.imageAlt': 'Vista aerea di Locarno, Svizzera, con il paesaggio del Ticino sullo sfondo, che mostra una piazza del mercato vivace e edifici moderni.',
    ...
    'blog.article.avs-prestazioni-complementari-ginevra.title': 'AVS e prestazioni complementari Canton Ginevra',
    'blog.article.avs-prestazioni-complementari-ginevra.excerpt': 'Come funziona l\'AVS nel Canton Ginevra: cassa di compensazione, calcolo della rendita, lacune contributive e prestazioni complementari per il minimo vitale.',
    'blog.article.avs-prestazioni-complementari-ginevra.imageAlt': 'Scrivania di ufficio amministrativo cantonale con documenti di rendita AVS e prestazioni complementari, ambiente di lavoro professionale.',
    'blog.article.imposta-successione-appenzello-interno-aliquote.title': 'Imposta successione Appenzello Interno: aliquote ed esenzioni',
    'blog.article.imposta-successione-appenzello-interno-aliquote.excerpt': 'Guida alla tassazione successoria in Appenzello Interno: come funzionano aliquote per grado di parentela, esenzioni coniuge e figli, procedura dichiarazione.',
    'blog.article.imposta-successione-appenzello-interno-aliquote.imageAlt': 'Paesaggio tradizionale del cantone Appenzello Interno con architettura alpina svizzera',
    ...
    'blog.article.emissione-prestiti-federali-2026.title': 'Emissione prestiti federali: CHF 368,6 miliardi',
    'blog.article.emissione-prestiti-federali-2026.excerpt': 'Confederazione svizzera ha emesso il 9 settembre 2026 due prestiti federali: CHF 161,240 milioni al 0,875% fino a giugno 2041, e CHF 207,390 milioni al 0,5% fino a maggio 2058. Volume totale di CHF 368,630 milioni.',
    'blog.article.emissione-prestiti-federali-2026.imageAlt': 'Sala di trading svizzera con terminali finanziari e franchi svizzeri che rappresentano l\'economia federale',
