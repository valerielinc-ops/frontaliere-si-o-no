...
function collectionJsonLd(pathValue: PharmacyPath, title: string, pharmacies: Pharmacy[]): string {
  ...
  // invisible URLs into every hub page. The visible directory remains
  // complete; `numberOfItems` preserves its full size and the first ten
  // entries provide a representative ItemList sample.
