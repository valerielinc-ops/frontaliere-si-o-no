...
export const SECTION_EDITORIAL: SectionEditorialMap = {
 ...
 'A practical example (simplified estimate): Marco, a software engineer hired in Lugano on 1 September 2023 with a CHF 84,000 gross salary, resident in Como, falls under the new cross-border workers regime. He pays about CHF 7,800 of Swiss withholding tax (80% of the ~11.5% ordinary rate) and in Italy declares the CHF 84,000 converted to EUR (~EUR 87,500 assuming an exchange rate of CHF 0.96 per EUR 1), then subtracts the 10,000 EUR exemption. On the residual EUR 77,500 taxable base, gross IRPEF under the 2026 brackets (23-33-43%) is about EUR 25,500. The foreign tax credit recognises the Swiss tax paid (EUR 8,125) in proportion to the residual base (77,500 ÷ 87,500), i.e. about EUR 7,200. The Italian IRPEF balance is therefore about EUR 18,300, payable via F24 form. The estimate ignores deductible Swiss social contributions, which lower the taxable base, and the regional and municipal surcharges, which raise the tax: the actual balance depends on these items.',
