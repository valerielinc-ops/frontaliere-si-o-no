...
export const SECTION_EDITORIAL: SectionEditorialMap = {
 ...
 'Grenzgänger sollten beachten, dass italienische Feiertage in der Schweiz nicht automatisch gelten (lex loci laboris). In Ticino arbeitende Grenzgänger unterliegen dem Schweizer Feiertagskalender: italienische Feiertage wie der 25. April (Tag der Befreiung), 2. Juni (Tag der Republik) und lokale Schutzpatrontage sind normale Arbeitstage. Mit schriftlicher Arbeitgebervereinbarung können italienische Nationalfeiertage als Urlaubstage genommen werden.',
 ...
 'Der Kalender 2026 bietet attraktive Brückentage zur Urlaubsoptimierung: Ostern (Karfreitag 3. April + Ostermontag 6. April, 4 Tage mit null Urlaub), Auffahrt (Donnerstag 14. Mai, Brücke mit Freitag 15. Mai), Fronleichnam (Donnerstag 4. Juni, Brücke mit Freitag 5. Juni) und Maria Empfängnis (Dienstag 8. Dezember, Brücke mit Montag 7. Dezember). Mit geschickter Planung kann ein Grenzgänger bis zu 25-28 effektive Urlaubstage mit nur 15-17 Urlaubstagen erhalten.',
