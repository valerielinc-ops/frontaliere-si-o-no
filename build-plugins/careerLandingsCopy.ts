...
const IT_AGENZIE: CareerLandingCopy = {
  ...
  description:
    'Agenzie del lavoro a Lugano: come verificare l\'autorizzazione SECO, cosa controllare nel contratto interinale, diritti del frontaliere con permesso G.',
...
const IT_STAGE: CareerLandingCopy = {
  ...
  description:
    'Stage a Lugano: aziende svizzere aperte a tirocinanti italiani, indennità tipiche in Ticino, contratto e fisco per frontalieri con permesso G.',
...
const IT_CONTRATTI: CareerLandingCopy = {
  ...
  description:
    'Contratti di lavoro per frontalieri in Ticino: CCL per settore, imposta alla fonte, ferie, malattia, tredicesima e LPP, clausole da controllare.',
...
> = {
  en: {
    'agenzie-lavoro-lugano': {
      ...
      description:
        'Staffing agencies in Lugano: how to verify SECO authorisation, what to check in a temporary contract, and permit G cross-border worker rights.',
    ...
    'concorsi-pubblici-lugano': {
      ...
      description:
        'Open public-sector jobs in Lugano and Canton Ticino: nurses, administrative staff, assistant doctors, interns. Requirements and deadlines.',
    ...
    'stage-lugano': {
      ...
      description:
        'Internships in Lugano: Swiss employers open to Italian trainees, typical stipends in Ticino, contract and tax rules for permit G holders.',
    ...
    'contratti-lavoro-frontalieri': {
      ...
      description:
        'Cross-border employment contracts in Ticino: collective agreements by sector, source tax, vacation, sick leave, 13th salary, LPP and clauses to check.',
  ...
  de: {
    'agenzie-lavoro-lugano': {
      ...
      description:
        'Personalverleih und Stellenvermittlung in Lugano: SECO-Autorisierung prüfen, Temporärvertrag-Checkliste, Rechte für Grenzgänger mit G-Bewilligung.',
    ...
    'concorsi-pubblici-lugano': {
      ...
      description:
        'Offene öffentliche Stellen in Lugano und im Kanton Tessin: Pflege, Verwaltung, Assistenzärzte, Praktika. Anforderungen und Bewerbungsfristen.',
    ...
    'stage-lugano': {
      ...
      description:
        'Praktikum in Lugano: Schweizer Unternehmen für italienische Praktikanten, übliche Vergütungen im Tessin, Vertrag und Steuern mit G-Bewilligung.',
    ...
    'contratti-lavoro-frontalieri': {
      ...
      description:
        'Arbeitsverträge für Grenzgänger im Tessin: GAV pro Sektor, Quellensteuer, Ferien, Krankheit, 13. Monatslohn, BVG und zu prüfende Klauseln.',
  ...
  fr: {
    'agenzie-lavoro-lugano': {
      ...
      description:
        "Agences de placement et d'intérim à Lugano : vérifier l'autorisation SECO, contrôler un contrat temporaire, droits des frontaliers avec permis G.",
    ...
    'concorsi-pubblici-lugano': {
      ...
      description:
        "Postes publics ouverts à Lugano et au Canton Tessin : infirmiers, administratifs, médecins assistants, stages. Conditions et délais.",
    ...
    'stage-lugano': {
      ...
      description:
        "Stage à Lugano : entreprises suisses ouvertes aux stagiaires italiens, indemnités typiques au Tessin, contrat et fiscalité avec permis G.",
    ...
    'contratti-lavoro-frontalieri': {
      ...
      description:
        "Contrats de travail pour frontaliers au Tessin : CCT par secteur, impôt à la source, vacances, maladie, 13e salaire, LPP et clauses à vérifier.",
