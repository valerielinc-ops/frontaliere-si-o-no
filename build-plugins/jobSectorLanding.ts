...
export * from './shared/jobSectorPaths';
...
export const SECTOR_HUB_DISPLAY: Record<JobBoardLocale, Record<SectorHubKey, string>> = {
  it: {
    ...
    contabili: 'Contabili',
    banca: 'Banca e finanza',
    assicurazioni: 'Assicurazioni',
    consulenza: 'Consulenza',
    avvocati: 'Avvocati e legale',
    'risorse-umane': 'Risorse umane',
    marketing: 'Marketing',
    vendite: 'Vendite',
    commercio: 'Commercio al dettaglio',
    trasporti: 'Trasporti',
    magazzino: 'Magazzinieri',
    meccanici: 'Meccanici',
    ...
    pulizie: 'Pulizie',
    sicurezza: 'Sicurezza',
    scuola: 'Scuola e formazione',
    designer: 'Designer e creativi',
    architetti: 'Architetti',
    agricoltura: 'Agricoltura',
    energia: 'Energia e utility',
  ...
  fr: {
    ...
    medici: 'Médecins',
    fisioterapisti: 'Physiothérapeutes',
    ...
    marketing: 'Marketing',
    vendite: 'Ventes',
    commercio: 'Commerce de détail',
    trasporti: 'Transport',
    magazzino: 'Magasiniers',
    meccanici: 'Mécaniciens',
    elettricisti: 'Électriciens',
    idraulici: 'Plombiers',
    edilizia: 'Construction',
...
export const SECTOR_MATCHERS: Record<SectorHubKey, RegExp> = {
  ...
  medici: /\bmedic[oai]\b|\bdottor|\bmediziner|\barzt\b|\bärzt|\bphysician\b|\bdoctor\b|\bm[eé]decin\b|oberarzt|assistenzarzt|primario|chirurg/i,
...
export function buildSectorHubSeo(
  ...
  switch (locale) {
    case 'it': {
      const nounMap = SECTOR_HUB_DISPLAY[locale];
