     ...
     switch (locale) {
       case 'it':
         return [
           ...
           `<p>Usa il <a class="s-EBYcGk" href="/calcola-stipendio/">calcolatore di stipendio netto</a> per simulare il netto in mano partendo dal lordo proposto, oppure il <a class="s-EBYcGk" href="/comparatori/cambio-valuta/">confronto cambio CHF/EUR</a> per capire quanto rende oggi un'offerta in franchi svizzeri rispetto ad un equivalente italiano in euro.</p>`,
           `</section>`,
         ].join('');
       case 'en':
         return [
           ...
           `<p>Use the <a class="s-EBYcGk" href="/en/salary-calculator/">net-salary calculator</a> to simulate take-home pay starting from a gross offer, or the <a class="s-EBYcGk" href="/en/comparators/currency-exchange/">CHF/EUR exchange comparator</a> to gauge how much a Swiss offer in francs is worth today versus an Italian equivalent in euros.</p>`,
           `</section>`,
         ].join('');
       case 'de':
         return [
       ...
       default:
         return [
           ...
           `<p>Utilisez le <a class="s-EBYcGk" href="/fr/calculer-salaire/">calculateur de salaire net</a> pour simuler le net à partir d'une offre brute, ou le <a class="s-EBYcGk" href="/fr/comparateurs/change-monnaie/">comparateur du change CHF/EUR</a> pour évaluer la valeur actuelle d'une offre suisse en francs face à une offre italienne équivalente en euros.</p>`,
           `</section>`,
         ].join('');
     }
   };
