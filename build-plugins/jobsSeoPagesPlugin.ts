     ...
     switch (locale) {
       case 'it':
         return [
           ...
           `<p>Usa il <a class="s-EBYcGk" href="${CALC_HREF.it}">calcolatore di stipendio netto</a> per simulare il netto in mano partendo dal lordo proposto, oppure il <a class="s-EBYcGk" href="/comparatori/cambio-valuta/">confronto cambio CHF/EUR</a> per capire quanto rende oggi un'offerta in franchi svizzeri rispetto ad un equivalente italiano in euro.</p>`,
           `</section>`,
         ].join('');
       case 'en':
         return [
