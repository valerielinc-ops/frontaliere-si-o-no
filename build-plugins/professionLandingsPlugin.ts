...
const RELATED_LINKS: Record<ProfessionLocale, Array<{ href: string; label: string }>> = {
  it: [
    ...
    { href: '/guida-frontaliere/permesso-g/', label: 'Guida al permesso G' },
  ...
  en: [
    ...
    { href: '/en/guide/permit-g/', label: 'Permit G guide' },
    { href: '/en/guide/new-cross-border-law-2026/', label: '2026 new cross-border tax agreement' },
  ],
  de: [
    ...
    { href: '/de/leitfaden/bewilligung-g/', label: 'G-Bewilligungs-Leitfaden' },
    { href: '/de/leitfaden/neues-grenzgaenger-gesetz-2026/', label: 'Neues Grenzgänger-Gesetz 2026' },
  ],
  fr: [
    ...
    { href: '/fr/guide/permis-g/', label: 'Guide du permis G' },
    { href: '/fr/guide/nouvelle-loi-frontalier-2026/', label: 'Nouvel accord frontalier 2026' },
  ],
};
