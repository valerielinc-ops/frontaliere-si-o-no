...
// in `packages/articles/engine/shared/articleArchiveUnion.ts`. This file
// exists only so every pre-existing `build-plugins/shared/articleArchiveUnion`
...
export * from '../../packages/articles/engine/shared/articleArchiveUnion';
