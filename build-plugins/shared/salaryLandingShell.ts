  ...
  'nuovi-frontalieri-oltre-20-km': {
    it: {
      ...
      tiles: [
        ...
        { label: 'Costo medio extra', value: '~EUR 3.000/anno', tone: 'warning' },
    ...
    en: {
      ...
      tiles: [
        ...
        { label: 'Median extra cost', value: '~EUR 3,000/year', tone: 'warning' },
    ...
    de: {
      ...
      tiles: [
        ...
        { label: 'Median-Mehrkosten', value: '~EUR 3.000/Jahr', tone: 'warning' },
    ...
    fr: {
      ...
      tiles: [
        ...
        { label: 'Coût médian extra', value: '~EUR 3 000/an', tone: 'warning' },
