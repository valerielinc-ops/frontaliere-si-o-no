...
var C={it:{live:"live (Firestore, agg. ",offline:"snapshot — dato live non disponibile",stale:"snapshot — lettura live non disponibile",na:"non disponibile",both:"Entrambi",it:"IT → CH",ch:"CH → IT",g:"Scorrevole",y:"Moderata",r:"Lunga"},en:{live:"live (Firestore, upd. ",offline:"snapshot — live data unavailable",stale:"snapshot — no fresh live reading",na:"unavailable",both:"Both directions",it:"Italy → Switzerland",ch:"Switzerland → Italy",g:"Free-flowing",y:"Moderate",r:"Long"},de:{live:"live (Firestore, akt. ",offline:"Snapshot — Live-Daten nicht verfügbar",stale:"Snapshot — keine aktuelle Live-Messung",na:"nicht verfügbar",both:"Beide Richtungen",it:"Italien → Schweiz",ch:"Schweiz → Italien",g:"Fliessend",y:"Moderat",r:"Lang"},fr:{live:"live (Firestore, maj. ",offline:"instantané — données live indisponibles",stale:"instantané — aucune mesure live récente",na:"indisponible",both:"Les deux directions",it:"Italie → Suisse",ch:"Suisse → Italie",g:"Fluide",y:"Modérée",r:"Longue"}}[L]||null;
