...
function renderSnapshotPage(inp: SnapshotPageInputs): string {
  ...
  const bodyHtml = `<article class="s-xzWvwM">
    <nav class="s-bcr">
      ...
      <span> / </span>
      <a href="${buildHubPath(locale)}" class="s-bcl">${esc(JOB_MARKET_HUB_NAME[locale])}</a>
      <span> / </span>
