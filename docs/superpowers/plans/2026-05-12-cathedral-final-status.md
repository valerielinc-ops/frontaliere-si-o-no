...
$ git worktree list
~/Projects/frontaliere-si-o-no  12e15e5530 [main]
...
Cathedral worktree at `~/Projects/cathedral-wt` was cleaned up. Branch `cathedral-canton-aware-completion` deleted locally and on remote. Three orphan PRs from other orchestrators (#103, #104, #105) processed: #103 + #105 merged to main; #104 closed (stale 196 commits behind).
