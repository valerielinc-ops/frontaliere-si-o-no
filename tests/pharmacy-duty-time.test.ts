...
describe('pharmacy duty Zurich local time', () => {
  ...
  it('rejects an ambiguous fall-back time instead of choosing a boundary', () => {
    expect(() => localDateTimeToIso('25/10/2026', '02:30'))
      .toThrow(/Ambiguous Zurich local datetime/);
  });
