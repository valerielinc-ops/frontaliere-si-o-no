...
describe('telemetry helpers', () => {
  ...
  it('collects both repair workflows, issue-fix, and the queued issue count', () => {
    ...
    expect(collectRepairQuotaStats({ repo: 'owner/repo', since: '2026-09-05', runJson })).toEqual({
      ok: true,
      since: '2026-09-05',
      repairRuns: 2,
      issueFixRuns: 1,
    ...
    expect(seen).toHaveLength(REPAIR_WORKFLOWS.length + 2);
  });

  it('fails open when a telemetry listing is malformed', () => {
