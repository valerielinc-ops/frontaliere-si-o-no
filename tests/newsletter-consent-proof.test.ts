...
describe('the register is versioned, and editing a formula cannot be silent', () => {
  ...
  const PINNED: Record<string, { version: string; text: string }> = {
    communicationsOptIn: {
      ...
      text: 'Iscrivo il mio indirizzo alle comunicazioni di Frontaliere Ticino. Cosa ricevo, con che frequenza, come disdire e chi tratta i dati: frontaliereticino.ch/comunicazioni (versione 2026-08-14.1).',
    },
    communicationsSignIn: {
      version: '2026-08-14.1',
      text: 'Accedendo iscrivo il mio indirizzo alle comunicazioni di Frontaliere Ticino. Cosa ricevo, con che frequenza, come disdire e chi tratta i dati: frontaliereticino.ch/comunicazioni (versione 2026-08-14.1).',
    },
  ...
  const SIGN_IN_LOCALES = {
    en: 'By signing in I subscribe my address to the Frontaliere Ticino communications. What I receive, how often, how to stop it and who processes the data: frontaliereticino.ch/comunicazioni (version 2026-08-14.1).',
    de: 'Mit der Anmeldung trage ich meine Adresse in die Mitteilungen von Frontaliere Ticino ein. Was ich erhalte, wie oft, wie ich abbestelle und wer die Daten bearbeitet: frontaliereticino.ch/comunicazioni (Version 2026-08-14.1).',
    fr: 'En me connectant, j’inscris mon adresse aux communications de Frontaliere Ticino. Ce que je reçois, à quelle fréquence, comment me désinscrire et qui traite les données : frontaliereticino.ch/comunicazioni (version 2026-08-14.1).',
  } as const;

  const PINNED_LOCALES: Record<string, Record<'en' | 'de' | 'fr', string>> = {
    communicationsOptIn: {
      en: 'I subscribe my address to the Frontaliere Ticino communications. What I receive, how often, how to stop it and who processes the data: frontaliereticino.ch/comunicazioni (version 2026-08-14.1).',
      de: 'Ich trage meine Adresse in die Mitteilungen von Frontaliere Ticino ein. Was ich erhalte, wie oft, wie ich abbestelle und wer die Daten bearbeitet: frontaliereticino.ch/comunicazioni (Version 2026-08-14.1).',
      fr: 'J’inscris mon adresse aux communications de Frontaliere Ticino. Ce que je reçois, à quelle fréquence, comment me désinscrire et qui traite les données : frontaliereticino.ch/comunicazioni (version 2026-08-14.1).',
    },
