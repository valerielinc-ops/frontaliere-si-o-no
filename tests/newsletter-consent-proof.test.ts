...
describe('the register is versioned, and editing a formula cannot be silent', () => {
  ...
  const PINNED: Record<string, { version: string; text: string }> = {
    communicationsOptIn: {
      ...
      text: 'Registrandomi accetto le condizioni e mi iscrivo alle comunicazioni di Frontaliere Ticino. Condizioni (v. 2026-09-25.1).',
    },
    communicationsSignIn: {
      version: '2026-09-25.1',
      text: 'Registrandomi o accedendo accetto le condizioni e mi iscrivo alle comunicazioni di Frontaliere Ticino. Condizioni (v. 2026-09-25.1).',
    },
  ...
  const SIGN_IN_LOCALES = {
    en: 'By registering or signing in I accept the terms and subscribe to Frontaliere Ticino communications. Terms (v. 2026-09-25.1).',
    de: 'Mit der Registrierung oder Anmeldung akzeptiere ich die Bedingungen und abonniere die Mitteilungen von Frontaliere Ticino. Bedingungen (V. 2026-09-25.1).',
    fr: 'En m’inscrivant ou en me connectant, j’accepte les conditions et m’inscris aux communications de Frontaliere Ticino. Conditions (v. 2026-09-25.1).',
  } as const;

  const PINNED_LOCALES: Record<string, Record<'en' | 'de' | 'fr', string>> = {
    communicationsOptIn: {
      en: 'By registering I accept the terms and subscribe to Frontaliere Ticino communications. Terms (v. 2026-09-25.1).',
      de: 'Mit der Registrierung akzeptiere ich die Bedingungen und abonniere die Mitteilungen von Frontaliere Ticino. Bedingungen (V. 2026-09-25.1).',
      fr: 'En m’inscrivant, j’accepte les conditions et m’inscris aux communications de Frontaliere Ticino. Conditions (v. 2026-09-25.1).',
    },
