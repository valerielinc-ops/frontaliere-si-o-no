...
const pub = (companyKey: string, title: string, extra = {}) => ({ source: PUBLISHER_SOURCE_KEY, companyKey, title, ...extra });
const crawled = (companyKey: string, title: string, extra = {}) => ({ source: 'acme-crawler', companyKey, title, ...extra });
