...
describe('SEO alias pages', () => {
  it('emits a canonical bridge page for flat aliases', () => {
    const html = buildFlatRedirect(
      'https://frontaliereticino.ch/de/statistiken/beste-grenzgemeinden/',
    ...
    expect(html).toContain('href="https://frontaliereticino.ch/de/statistiken/beste-grenzgemeinden/"');
