...
const NARROWING_ALLOWLIST: Record<string, string> = {
  '.github/workflows/post-deploy-validate-dist.yml:1722:6':
    'validatore post-deploy: il fallback vivo alla riga 1722 passa --reopen-within-hours 6 e --build-sha "${INPUT_DEPLOY_REF}"; collassa il flap rosso→verde→rosso dentro UN ciclo di deploy (#928/#931/#937/#941) e ha il guard anti-latenza #5539.',
