...
const TRANSLATIONS = {
 ...
 manageStopAllTitle: 'Tutte le email sono state disattivate',
 manageStopAllBody: 'Hai bloccato tutte le email di Frontaliere Ticino, inclusi newsletter, avvisi lavoro, promemoria e comunicazioni promozionali.',
 manageStopAllNote: 'Puoi riattivare singoli canali dal centro preferenze con una nuova scelta esplicita.',
 ...
 manageStopAllTitle: 'All emails have been turned off',
 manageStopAllBody: 'You have blocked all emails from Frontaliere Ticino, including newsletters, job alerts, reminders and promotional messages.',
 manageStopAllNote: 'You can reactivate individual channels from the preferences centre with a new explicit choice.',
 ...
 manageStopAllTitle: 'Alle E-Mails wurden deaktiviert',
 manageStopAllBody: 'Sie haben alle E-Mails von Frontaliere Ticino blockiert, einschliesslich Newsletter, Job-Alerts, Erinnerungen und Werbenachrichten.',
 manageStopAllNote: 'Sie können einzelne Kanäle im Präferenzzentrum mit einer neuen ausdrücklichen Auswahl wieder aktivieren.',
 ...
 manageStopAllTitle: 'Tous les e-mails ont été désactivés',
 manageStopAllBody: 'Vous avez bloqué tous les e-mails de Frontaliere Ticino, y compris la newsletter, les alertes emploi, les rappels et les messages promotionnels.',
 manageStopAllNote: 'Vous pouvez réactiver des canaux individuels depuis le centre de préférences avec un nouveau choix explicite.',
