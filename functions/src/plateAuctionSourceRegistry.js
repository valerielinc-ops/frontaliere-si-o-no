...
const RAW = {
  ...
  fr: ['Friburgo', 'FR', 'https://appls.ocn.ch/ecari-auction/ui/app/init?locale=fr_ch', { ...ACTIVE_ECARI, termsOfUse: 'official OCN auction portal; review source terms before increasing frequency', status: 'blocked', notes: 'Official OCN page links this public eCari catalogue; bidder identity fields are discarded.' }],
  ...
  ti: ['Ticino', 'TI', 'https://www.carieauktion.ti.ch/ecari-auktion/', { ...ACTIVE_ECARI, termsOfUse: 'official Ticino eCari catalogue; review source terms before increasing frequency', status: 'blocked', notes: 'Live eCari catalogue revalidated; bidder identity fields are discarded.' }],
