...
const RAW = {
  ...
  bs: ['Basilea Città', 'BS', 'https://www.bs.ch/fr/node/31897', { status: 'no-public-auction', accessMethod: 'manual', fetchFrequency: 'P1D', rateLimit: 'not applicable', termsOfUse: 'not applicable', notes: 'Official Wunschkontrollschilder service exposes fixed-price plate offers, not a public auction catalogue.' }],
