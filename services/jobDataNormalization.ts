...
// scripts/download-company-logos.mjs or scripts/download-missing-company-logos.mjs
// and overlaid onto the registry below
...
export const CRAWLED_COMPANY_LOGOS: Record<string, string> = {
 ...
 'kanton-aargau': '/images/brands/kanton-aargau.png',
 'ksml': gFavicon('be.ch'),
...
// SEO pages alike. Refresh with `node scripts/download-company-logos.mjs` or
// the canonical audit downloader.
...
export function normalizeJobContract(raw: unknown, title = '', description = ''): CanonicalContractType {
 ...
 if (looksLike(norm, /\b(thesis|internship|intern(?:ship)?s?(?![a-zA-Z0-9_À-ÖØ-öø-ÿ])|stages?(?![a-zA-Z0-9_À-ÖØ-öø-ÿ])|tirocin|apprendist|praktikum)/)) return 'internship';
