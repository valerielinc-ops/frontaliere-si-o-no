...
export const FAQ_TRANSLATIONS: FaqLocaleMap = {
 ...
 "Quali documenti servono per il permesso G?": {
 en: { q: "Which documents are needed for the G permit?", a: "For the G permit you need: signed Swiss employment contract, valid EU ID card or passport, Italian residence certificate proving the address within the 20 km border zone, two recent passport photos, and the cantonal form (Ticino: Migration Office SEM). Cost: CHF 65–140 depending on canton. The employer usually files the application on behalf of the employee via the cantonal online counter." },
 de: { q: "Welche Dokumente werden fuer die G-Bewilligung benoetigt?", a: "Fuer die G-Bewilligung benoetigen Sie: unterzeichneten Schweizer Arbeitsvertrag, gueltigen EU-Ausweis oder Reisepass, italienische Wohnsitzbescheinigung mit Nachweis der Adresse im 20-km-Grenzgebiet, zwei aktuelle Passfotos und das kantonale Formular (Tessin: Migrationsamt SEM). Kosten: CHF 65–140 je nach Kanton. Der Arbeitgeber reicht den Antrag meist im Namen der angestellten Person ueber den kantonalen Online-Schalter ein." },
 fr: { q: "Quels documents faut-il pour le permis G ?", a: "Pour le permis G il faut : un contrat de travail suisse signe, une carte d'identite ou un passeport UE en cours de validite, un certificat de residence italien attestant l'adresse dans la zone frontaliere de 20 km, deux photos d'identite recentes et le formulaire cantonal (Tessin : Office de la migration SEM). Cout : CHF 65–140 selon le canton. L'employeur depose habituellement la demande au nom du salarie via le guichet en ligne cantonal." }
 },
