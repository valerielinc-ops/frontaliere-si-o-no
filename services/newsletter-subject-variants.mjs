...
export const SUBJECT_VARIANTS = [
  {
    ...
    styleDirective: {
      it: 'STILE A/B "concreto": punta su numero + luogo + beneficio tangibile. Forme tipo "📊 3 aziende assumono a Lugano" o "💰 Simula il netto 2026 in 30 sec". Specifico e diretto, niente mistero. Non chiamare il lettore "frontaliere": parla del suo bisogno.',
      en: 'A/B STYLE "concrete": lead with a number + location + tangible benefit. Forms like "📊 3 companies hiring in Lugano" or "💰 Simulate your 2026 net pay in 30 sec". Specific and direct, no mystery. Do not label the reader; lead with the need.',
      de: 'A/B-STIL "konkret": Zahl + Ort + greifbarer Nutzen. Formen wie "📊 3 Firmen stellen in Lugano ein" oder "💰 Nettolohn 2026 in 30 Sek berechnen". Konkret und direkt, kein Rätsel. Leser nicht als Grenzgänger bezeichnen; den Bedarf nennen.',
      fr: 'STYLE A/B "concret" : un chiffre + un lieu + un bénéfice tangible. Formes comme "📊 3 entreprises recrutent à Lugano" ou "💰 Simule ton net 2026 en 30 sec". Précis et direct, pas de mystère. Ne qualifie pas le lecteur : parle de son besoin.',
    },
    fallback: {
      it: '📊 Cambio, lavoro e netto: guida 2026',
      en: '📊 Rates, jobs and your 2026 net pay',
      de: '📊 Kurs, Jobs und dein Nettolohn 2026',
      fr: '📊 Taux, emplois et votre salaire net 2026',
    },
  },
  {
    id: 'curioso',
    ...
    styleDirective: {
      it: 'STILE A/B "curioso": apri un curiosity gap o una domanda che il lettore DEVE risolvere aprendo. Forme tipo "⚡ Il tasso CHF scende: quanto perdi?" o "🤔 Permesso G o B? Il calcolo che conta". Crea tensione, non svelare la risposta. Non chiamare il lettore "frontaliere".',
      en: 'A/B STYLE "curious": open a curiosity gap or a question the reader MUST resolve by opening. Forms like "⚡ The CHF rate is dropping: how much are you losing?" or "🤔 Permit G or B? The calc that matters". Build tension, do not reveal the answer. Do not label the reader.',
      de: 'A/B-STIL "neugierig": eine Neugier-Lücke oder Frage, die der Leser nur durch Öffnen löst. Formen wie "⚡ CHF-Kurs fällt: wie viel verlierst du?" oder "🤔 Bewilligung G oder B? Die Rechnung zählt". Spannung aufbauen, die Antwort nicht verraten. Leser nicht als Grenzgänger bezeichnen.',
      fr: 'STYLE A/B "curieux" : ouvre un manque de curiosité ou une question que le lecteur DOIT résoudre en ouvrant. Formes comme "⚡ Le taux CHF baisse : combien tu perds ?" ou "🤔 Permis G ou B ? Le calcul qui compte". Crée la tension, ne révèle pas la réponse. Ne qualifie pas le lecteur de frontalier.',
    },
    fallback: {
      it: '🤔 Il cambio CHF ti sta costando?',
      en: '🤔 Is the CHF rate costing you?',
      de: '🤔 Kostet dich der CHF-Kurs Geld?',
      fr: '🤔 Le taux CHF te coûte-t-il cher ?',
    },
  },
];
