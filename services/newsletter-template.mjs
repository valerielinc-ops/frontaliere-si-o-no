...
const NL_I18N = {
  it: {
    ...
    closerText: 'Ti \u00e8 piaciuta questa email? Inoltrala a quel collega che ogni luned\u00ec chiede "ma com\u2019\u00e8 il cambio oggi?".',
    closerTag: 'A luned\u00ec prossimo. \u2615',
  ...
  en: {
    ...
    closerText: 'Liked this email? Forward it to that colleague who asks "what\u2019s the rate today?" every Monday.',
    closerTag: 'See you next Monday. \u2615',
  ...
  de: {
    ...
    closerText: 'Hat dir diese E-Mail gefallen? Leite sie an den Kollegen weiter, der jeden Montag fragt "Wie steht der Kurs?".',
    closerTag: 'Bis n\u00e4chsten Montag. \u2615',
  ...
  fr: {
    ...
    closerText: 'Tu as aim\u00e9 cet email ? Transf\u00e8re-le au coll\u00e8gue qui demande "c\u2019est quoi le taux ?" chaque lundi.',
    closerTag: '\u00c0 lundi prochain. \u2615',
  ...
  return `
    <tr><td class="footer-pad" style="background:${BRAND_DARK};padding:28px;text-align:center;">
      <div style="margin-bottom:12px;">
        <a href="https://www.facebook.com/frontaliereticino" style="display:inline-block;margin:0 6px;font-size:18px;text-decoration:none;">\ud83d\udcd8</a>
        <a href="https://www.instagram.com/frontaliereticino" style="display:inline-block;margin:0 6px;font-size:18px;text-decoration:none;">\ud83d\udcf8</a>
