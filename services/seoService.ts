...
} from './pharmacies/data';
import { buildPharmacyPath, type PharmacyPath } from './pharmacies/paths';
import { buildDutyWeekModel } from './pharmacies/dutyWeek';
import type { PharmacyCatalogueDataset, PharmacyDutiesDataset } from './pharmacies/types';
...
export async function updateMetaTags(section: string): Promise<void> {
 ...
 ? resolvePharmacySeoMetadata(route.pharmacyPath)
 : null;
