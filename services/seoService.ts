...
function buildBreadcrumbs(section: string, route: AppRoute, locale: Locale, blogTitle?: string): Record<string, any> {
 ...
 'blog-tappa-campione-ditalia-2025-commissione': { name: 'Ticino e Campione d’Italia', path: '/articoli-frontaliere/tappa-campione-ditalia-2025-commissione', parent: 'blog' },
    ...
    'blog-assicurazione-malattia-famiglia-frontaliere': { name: 'Assicurazione famiglia frontaliere', path: '/articoli-svizzera/assicurazione-malattia-famiglia-frontaliere/', parent: 'blog' },
    ...
    'blog-frontalieri-sede-datore-fuori-confine': { name: 'Sede del datore fuori confine', path: '/articoli-frontaliere/frontalieri-sede-datore-fuori-area-confine', parent: 'blog' },
    ...
    'blog-frontalieri-disoccupazione-riforma-ue-costi': { name: 'Frontalieri disoccupati', path: '/articoli-svizzera/frontalieri-disoccupazione-riforma-ue-costi/', parent: 'blog' },
 };
