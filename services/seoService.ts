...
function buildBreadcrumbs(section: string, route: AppRoute, locale: Locale, blogTitle?: string): Record<string, any> {
  ...
  const sectionNames: Record<string, { name: string; path: string; parent?: string }> = {
    ...
    'blog-frontalieri-ticino-calo-2025': { name: 'Calo Frontalieri Ticino', path: '/articoli-frontaliere/frontalieri-ticino-calo-dati-2025', parent: 'blog' },
    'blog-frontalieri-ticino-controtendenza-2026': { name: 'Dati Lavoro Frontalieri', path: '/articoli-frontaliere/frontalieri-ticino-dati-calo-q4-2025', parent: 'blog' },
    'blog-frontalieri-ticino-calo-q4-2025': { name: 'Dati Frontalieri Q4 2025', path: '/articoli-frontaliere/frontalieri-ticino-calo-dati-q4-2025', parent: 'blog' },
    ...
    'blog-tassa-salute-frontalieri-vantaggio-ticino': { name: 'Tassa frontalieri', path: '/articoli-frontaliere/tassa-salute-frontalieri-vantaggio-ticino', parent: 'blog' },
    ...
    'blog-tassa-salute-svizzera-vantaggio': { name: 'Tassa sulla salute', path: '/articoli-frontaliere/tassa-salute-svizzera-vantaggio', parent: 'blog' },
    ...
    'blog-tassa-salute-frontalieri-governo-svizzero': { name: 'Tassa sulla salute', path: '/articoli-frontaliere/tassa-salute-frontalieri-governo-svizzero', parent: 'blog' },
    ...
    'blog-frontalieri-ticino-decreto-omnibus': { name: 'Frontalieri Ticino', path: '/articoli-frontaliere/frontalieri-ticino-decreto-omnibus', parent: 'blog' },
