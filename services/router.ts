  ...
  switch (route.activeTab) {
    ...
    case 'fisco': {
      ...
      const map: Record<string, string> = {
        ...
        ristorni: 'ristorni', pension: 'pension', pillar3: 'pillar3', quiz: 'quiz', 'tax-credit': 'taxCredit', 'withholding-rates': 'withholdingRates',
      };
