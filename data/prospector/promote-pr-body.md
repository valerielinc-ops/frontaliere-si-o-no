...
- **blocked: serve una run successiva** — 120 candidati graduati non hanno superato il gate (2 solo per la stabilita' richiesta da 2 validazioni buone su 2 giorni distinti; 118 per altre condizioni). Le cause dettagliate sono nel log dello stadio PROMOTE: solo il primo gruppo si risolve con una run successiva. **Motivo:** la stabilita' o le altre condizioni del gate non sono ancora soddisfatte. **Prossimo passo:** eseguire una run successiva per ricontrollare la stabilita' e rivalutare le altre condizioni del gate.
