const e={"blog.article.blocco-ristorni-ticino-frontalieri-2026.body1":`## In brief
...
1. Evaluation of funds: Calculate the exact amount of refunds paid annually to Italian border towns.
2. Creation of the emergency fund: Establish a mechanism for managing the recovered funds.
3. Financing of health measures: Define the methods of distributing the funds to reduce health insurance premiums.
4. Communication with Italian authorities: Initiate a dialogue to explain the reasons for the blocking of refunds.
...
To reduce FX leakage, compare [CHF-EUR exchange options](nav:exchange) and [banks for cross-border workers](nav:banks).`,"blog.article.blocco-ristorni-ticino-frontalieri-2026.body3":`## Blockage of tax refunds: Lega dei Ticinesi proposes healthcare fund for cross-border workers

For cross-border workers who wish to calculate the potential impact of the blockage of tax refunds on their taxes and health insurance premiums, it is possible to use the [tax calculator](nav:calculator) available on Frontaliere Ticino. This tool allows you to estimate withholding taxes and health insurance premiums based on the new tax provisions. For example, a cross-border worker residing in Mendrisio with an annual income of 80,000 CHF might see an increase in their health insurance premium of approximately 500 CHF per year, while a resident in Lugano with an income of 100,000 CHF might face an increase of 800 CHF.
...
- Calculate withholding taxes using the [tax calculator](nav:calculator).
...
In conclusion, the proposal by the Lega dei Ticinesi to block tax refunds to Italy represents a turning point in the management of the Canton Ticino's tax resources. Cross-border workers should remain vigilant and prepare for any changes in their tax returns and health coverage. Using tools such as the [tax calculator](nav:calculator) and tax guides can help navigate this period of uncertainty and ensure optimal management of their finances.

*Source: [comozero.it](https://comozero.it/attualita/lega-ticinesi-proposta-blocco-ristorni-frontalieri-cassa-malati/)*`,"blog.article.blocco-ristorni-ticino-frontalieri-2026.faq":'[{"q":"What are the ristorni?","a":"Ristorni are the withholding taxes paid by cross-border workers who work in Switzerland and reside in Italy. These funds are then reimbursed to the Italian border municipalities."},{"q":"What are the two crucial measures funded by the emergency fund?","a":"The two crucial measures are the maximum cap of 10% of the available income to be allocated to health insurance premiums and the full deduction of health insurance costs from taxes."},{"q":"How can I prepare for potential tax changes?","a":"Consulting a tax advisor or a tax expert is the first step. Additionally, using tools like the [tax calculator](nav:calculator) and [tax guides](nav:tax-return) can help better understand the implications of the new provisions."}]'};export{e as default};
