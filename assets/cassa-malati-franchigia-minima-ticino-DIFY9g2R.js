const a={"blog.article.cassa-malati-franchigia-minima-ticino.body1":`## En bref
- Franchigia minima potrebbe aumentare da 300 a 400 franchi
- Consultazione aperta fino al 30 giugno 2024
- Bambini esenti dall'aumento della franchigia

## Faits clés
- **Franchigia minima**: 300 franchi (attuale), potrebbe aumentare a 400 franchi
- **Limite copertura**: 7.500 franchi per adulti, 1.000 franchi per bambini
- **Tasso partecipazione**: 13,5% delle prestazioni lorde coperte
- **Consultazione**: Aperta fino al 30 giugno 2024
- **Impatto economico**: Potenziale aumento costi per famiglie ticinesi
- **Esenzione**: Bambini esenti dall'aumento della franchigia
- **Scadenza**: 30 giugno 2024
- **Costo famiglia**: Da 1.200 a 1.600 franchi all'anno per una famiglia di 4 persone
...
Pour un calcul précis de votre salaire net en tant que frontalier, utilisez notre comparateur : l'outil le plus complet pour comparer votre salaire net entre permis G et permis B, avec toutes les déductions fiscales et sociales mises à jour pour 2026.`,"blog.article.cassa-malati-franchigia-minima-ticino.faq":`[{"q":"Quelle est l'actuelle allocation minimale d'assurance maladie en Suisse?","a":"L'indemnité minimale actuelle est de 300 francs."},{"q":"Quelle pourrait être l'incidence de l'augmentation de l'allocation minimale sur l'accès aux services de santé des familles à faible revenu au Tessin?","a":"L'augmentation de l'allocation minimale à 400 francs pourrait réduire l'accès aux services de santé pour les familles à faible revenu du Tessin, augmentant ainsi leur part des dépenses de santé. Par exemple, une famille ayant un revenu de 4 000 francs par mois pourrait voir augmenter sa contribution annuelle à l'assurance maladie d'environ 400 francs, ce qui pourrait représenter une charge importante."},{"q":"Comment cela pourrait-il affecter l'augmentation de l'allocation minimale le comportement des personnes dans l'utilisation des services de santé?","a":"Une augmentation minimale de l'allocation pourrait conduire à une plus grande responsabilité individuelle, réduisant les visites inutiles, mais elle pourrait aussi décourager certaines personnes d'avoir accès rapidement aux soins, ce qui augmenterait le risque de complications."}]`};export{a as default};
