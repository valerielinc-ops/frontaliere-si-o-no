const e={"blog.article.lugano-manifestazioni-regole-polemica.body1":`## TL;DR
- Lugano's municipality denied a right-wing demo, allowed left-wing protest
- Unauthorized left-wing protest occupied central square without police intervention
- Municipality's decision raises questions about equal treatment and institutional trust
- Costs of policing unauthorized event fall on Ticino taxpayers

## Key facts
- **Cosa**: Unauthorized left-wing protest in Piazza della Riforma
- **Quando**: On a crowded, sunny Saturday
- **Dove**: Piazza della Riforma, Lugano
- **Chi**: Left-wing circles with public support from elected politicians
- **Importo**: Massive police force mobilized to monitor the event
- **Scadenza**: Matter subject to an inter-party inquiry
- **Costo**: Costs fall entirely on Ticino's taxpayers
- **Data**: 22.02.2026 (likely a typo for the current year)

A political hornet's nest has been stirred in the heart of Lugano, raising a question as simple as it is fundamental: do the rules for demonstrating in the city apply to everyone equally? The fuse was lit by the Municipality's recent and controversial management of public events. Denouncing the incident is Andrea Togni, a PLR city councilor, who highlighted a clear disparity in treatment.

The facts, according to the reconstruction, are clear. A right-wing political group had duly requested authorization for a demonstration. The Municipality responded with a denial, motivated by the need to prevent possible risks and clashes, given the announced simultaneous presence of a left-wing counter-demonstration. A decision based on a principle of caution. The twist, however, came shortly after: the very central Piazza della Riforma was occupied by an unauthorized procession, linked to left-wing circles, complete with public support from elected politicians. All this took place on a crowded, sunny Saturday, with a significant deployment of police forces who, however, did not intervene to clear the square.`,"blog.article.lugano-manifestazioni-regole-polemica.body2":`## The principle of legality and the costs for the community
