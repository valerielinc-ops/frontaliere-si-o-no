const e={"blog.article.casse-malati-alloggi-landsgemeinde-2026.body1":`## In Kürze
...
### Wohnpolitik
Die Bürger lehnten einen Vorschlag der Liberalen Grünen ab, der darauf abzielte, den Anteil der günstigen Mietwohnungen zu erhöhen. Der Vorschlag sah die Ausarbeitung eines Gesetzes innerhalb von vier Jahren vor, aber die Gegner argumentierten, dass die Gemeinden bereits jetzt über die Instrumente verfügen, um Grundstücke an soziale Wohnungsbaugesellschaften zu vergeben. Diese Entscheidung könnte den lokalen Immobilienmarkt beeinflussen und es für Grenzgänger erschweren, erschwingliche Wohnungen zu finden.

### Entschädigungen für Raubtierangriffe
Landwirte, die Tiere durch Raubtierangriffe verlieren, erhalten eine Entschädigung nicht nur, wenn «klar nachgewiesen» ist, dass der Angriff von einem Wolf verursacht wurde, sondern auch in Fällen, in denen dies «hoch wahrscheinlich» ist. Diese Entscheidung könnte indirekte Auswirkungen auf Grenzgänger haben, die in ländlichen Gebieten leben oder im landwirtschaftlichen Sektor arbeiten.

Die Landsgemeinde ist eine Form der direkten Demokratie, die über 600 Jahre alt ist. Im Kanton Glarus können alle Wahlberechtigten, ab 16 Jahren, an Entscheidungen durch Handzeichen teilnehmen und Vorschläge einreichen. Dieses Ereignis stellt ein einzigartiges Beispiel für die direkte Beteiligung der Bürger am politischen und administrativen Leben des Kantons dar.`,"blog.article.casse-malati-alloggi-landsgemeinde-2026.body2":`## Praktische Analyse
...
### Entschädigungen für Raubtierangriffe
Die Entscheidung, die Entschädigungen auch auf Fälle auszudehnen, in denen ein Raubtierangriff „hoch wahrscheinlich“ ist, ist ein Fortschritt für die Landwirte. Dies könnte indirekt die Grenzgänger betreffen, die in ländlichen Gebieten leben oder im landwirtschaftlichen Sektor arbeiten, und ihnen eine größere wirtschaftliche Sicherheit im Falle von Verlusten bieten.

### Vergleich zur vorherigen Situation
Bevor diese Entscheidungen getroffen wurden, konnten Pendler die gesamten Reisekosten ohne Obergrenze abziehen. Darüber hinaus mussten die Subventionen für die Krankenkassenprämien explizit beantragt werden, was ein komplexeres bürokratisches Verfahren bedeutete. Die Wohnpolitik hatte keine wesentlichen Änderungen erfahren, und die Entschädigungen für Raubtierangriffe waren auf Fälle beschränkt, in denen der Angriff eindeutig nachgewiesen war.

## Nützliche Tools zum Schutz Ihres Nettolohns
Um Wechselkursverluste zu reduzieren, vergleichen Sie [CHF-EUR-Wechseloptionen](nav:exchange) und [Banken für Grenzgänger](nav:banks).`,"blog.article.casse-malati-alloggi-landsgemeinde-2026.body3":`## Konkrete Maßnahmen
...
Um dir bei der Bewältigung dieser neuen Bestimmungen zu helfen, kannst du die auf unserer Website verfügbaren Tools nutzen. Zum Beispiel kannst du den [Reisekostenrechner](nav:calculator) nutzen, um deine Ausgaben zu planen und sicherzustellen, dass du das Limit von 6.000 Franken einhältst. Außerdem kannst du den [Vergleich von Krankenversicherungen](nav:health) nutzen, um die beste Lösung für deine Bedürfnisse zu finden.

Mit diesen Informationen und Tools wirst du in der Lage sein, dich an die neuen Bestimmungen anzupassen und dein tägliches Leben als Grenzgänger bestmöglich zu gestalten.

*Quelle: [rsi.ch](https://www.rsi.ch/s/3712581)*`,"blog.article.casse-malati-alloggi-landsgemeinde-2026.faq":'[{"q":"Was ist der Höchstbetrag für die Abzugsfähigkeit der Pendlerkosten?","a":"Der Höchstbetrag für die Abzugsfähigkeit der Pendlerkosten beträgt 6.000 Franken. Diese Maßnahme ist Teil eines Sparpakets und wird ab dem nächsten Jahr in Kraft treten."},{"q":"Wie funktionieren die Subventionen für die Krankenkassenprämien?","a":"In Glarus muss niemand mehr als 15% des verfügbaren Einkommens für die Krankenkassenprämien ausgeben. Wer Anspruch auf die Reduktion hat, erhält diese automatisch, ohne einen Antrag stellen zu müssen."},{"q":"Was ändert sich in der Wohnpolitik?","a":"Die Bürger haben einen Vorschlag der Liberalen Grünen zur Erhöhung des Anteils von Wohnungen mit moderaten Mieten abgelehnt. Die Gemeinden verfügen bereits über die Instrumente, um Grundstücke an soziale Wohnungsbaugesellschaften zu vergeben."}]'};export{e as default};
