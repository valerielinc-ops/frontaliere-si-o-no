const e={"blog.article.malattia-frontaliere-guida-assicurazione.body1":`## En bref
...
Point crucial : le frontalier doit exercer son **droit d'option** entre LAMal et CMI **dans les 3 mois** suivant le début de son activité en Suisse. Ce choix est **contraignant** — une fois la décision prise, il n'est en principe pas possible de changer de système en cours d'activité (sauf événement majeur comme un mariage ou la naissance d'un enfant). Il est donc fondamental de comparer soigneusement les deux options avant de se décider. Utilisez notre [comparateur assurance maladie](nav:health) pour simuler les coûts et les couvertures des deux systèmes selon votre profil familial et médical.`,"blog.article.malattia-frontaliere-guida-assicurazione.body2":`## Salaire en cas de maladie : vos droits en Suisse
...
- **Exercez votre droit d'option** dans les 3 mois suivant le début de votre activité — comparez LAMal et CMI avec le [comparateur](nav:health)
- **Vérifiez les retenues IJM et LAA** sur votre fiche de salaire — utilisez le [calculateur salaire](nav:calculator) pour comprendre chaque déduction
...
- **Explorez** les opportunités professionnelles offrant de meilleures conditions d'assurance dans notre [bourse de l'emploi](nav:job-board)`,"blog.article.malattia-frontaliere-guida-assicurazione.faq":`[{"q":"Quelle est la couverture santé obligatoire pour les travailleurs transfrontaliers en Suisse?","a":"Les travailleurs transfrontaliers en Suisse doivent avoir une assurance santé. Les options sont le KVG suisse ou le CMI (Couverture Santé pour les Travailleurs Internationaux), qui vous permet de rester dans le Service national de santé italien grâce à une exemption."},{"q":"Quel est le processus pour passer du KVG au CMI ou inversement après le choix initial?","a":"Pour passer de KVG à CMI ou inversement après le choix initial, une procédure spécifique est requise. Le travailleur doit justifier la raison du changement (par exemple, modification des besoins de santé familiale) et soumettre une demande formelle à l'autorité compétente dans le délai imparti (généralement dans les 3 mois suivant un événement important). La demande peut nécessiter la documentation du nouveau statut (par exemple, naissance d'un enfant) et peut faire l'objet d'une évaluation au cas par cas."},{"q":"Comment fonctionne le remboursement des frais de santé en cas d'urgence en Suisse?","a":"Si vous choisissez le KVG, le traitement en Suisse est directement pris en charge par l'assurance et vous pouvez utiliser les installations suisses sans listes d'attente. Avec le CMI, le traitement en Suisse n'est couvert que pour les urgences et les accidents au travail, et vous pouvez utiliser le système de santé italien pour les soins ordinaires."}]`};export{e as default};
