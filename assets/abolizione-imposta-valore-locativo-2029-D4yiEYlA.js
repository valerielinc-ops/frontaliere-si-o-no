const e={"blog.article.abolizione-imposta-valore-locativo-2029.body1":`## TL;DR
...
To illustrate this, let's assume that a property owner in Bellinzona has a mortgage of CHF 200,000 with an interest rate of 3%. The mortgage interest is CHF 6,000 per year. Currently, the property owner can deduct the mortgage interest from their taxable income, but starting from 2029, the deduction will be limited to CHF 3,000 (50% of the mortgage interest).

### Energy-saving interventions

Property owners in Ticino will also need to plan for any energy-saving interventions by 2028 to benefit from the current deductions. The reform limits the deductions for energy-saving interventions starting from 2029.

To illustrate this, let's assume that a property owner in Lugano wants to install a floor heating system. The cost of the intervention is CHF 20,000. Currently, the property owner can deduct the cost of the intervention from their taxable income, but starting from 2029, the deduction will be limited to CHF 10,000.

### Concrete actions

To prepare for the fiscal reform, property owners in Ticino need to take some concrete actions:

1. Check with your local municipality about the possible introduction of a special tax on second homes.
2. Plan any energy-saving interventions by 2028 to take advantage of the current deductions.
3. Consult a tax consultant to assess the impact of the reform on your situation.

### Operational Checklist
To help homeowners prepare for the tax reform, we have created an operational checklist:
* Check with your local municipality about the possible introduction of a special tax on second homes
* Plan any energy-saving interventions by 2028 to take advantage of the current deductions
* Consult a tax consultant to assess the impact of the reform on your situation
* Calculate the impact of the reform on your specific case using our tax calculator

### Comparison of practical scenarios
Here is a comparison of practical scenarios to help homeowners understand the impact of the tax reform:
* Current scenario: homeowner of a house in Lugano with a mortgage of 200,000 francs with an interest rate of 3% and annual mortgage interest of 6,000 francs. The property is used as a primary residence.
* Scenario after the reform: homeowner of a house in Lugano with a mortgage of 200,000 francs with an interest rate of 3% and annual mortgage interest of 6,000 francs. The property is not used as a primary residence and is subject to the special tax on second homes.

The comparison between the two scenarios shows how the tax reform can have a significant impact on property management. Homeowners must consider the changes to mortgage interest deductions and the introduction of the special tax on second homes to plan their financial situation.

*Source: [tvsvizzera.it](https://www.tvsvizzera.it/tvs/qui-svizzera/cf-valore-locativo-imposizione-soppressa-dal-2029/91195741)*`,"blog.article.abolizione-imposta-valore-locativo-2029.faq":'[{"q":"When will the tax on rental value be abolished in Switzerland?","a":"The tax on rental value will be abolished as of January 1, 2029."},{"q":"How will the Cantons be compensated for the resulting tax losses?","a":"The Cantons will be able to introduce a special tax of up to 3.5% on secondary homes used primarily for personal purposes."},{"q":"What will happen to deductions for ordinary maintenance expenses?","a":"Deductions for ordinary maintenance expenses will be abolished for owner-occupied properties, but will remain mandatory for rented properties."},{"q":"How will mortgage interest be treated for owner-occupied properties?","a":"Mortgage interest will only be deductible for the portion related to rented properties. For first-time homebuyers, the maximum deduction will be CHF 5,000 per year for 10 years."},{"q":"What will happen to federal deductions for energy efficiency?","a":"Federal deductions for energy efficiency will be abolished, but the Cantons may retain them with a cap of CHF 15,000 per measure."}]'};export{e as default};
