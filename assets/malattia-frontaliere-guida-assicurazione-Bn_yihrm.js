const a={"blog.article.malattia-frontaliere-guida-assicurazione.body1":`## In breve
- LAMal
- CMI
- Certificato
...
Attenzione alla distinzione cruciale: se l'infortunio avviene **sul tragitto casa-lavoro** (Ticino → Italia), è classificato come infortunio non professionale (INP). L'INP è coperto dalla LAINF solo per i lavoratori con contratto superiore a 8 ore settimanali (la quasi totalità dei frontalieri). Il contributo INP è a carico del lavoratore, circa lo 0,7% del salario.`,"blog.article.malattia-frontaliere-guida-assicurazione.body3":`## Malattie rare e croniche: il caso Ticino
...
Per il [congedo parentale](nav:parental-leave) e le relative indennità, la nostra guida dettaglia tutte le casistiche.

## Checklist salute per il frontaliere

- **Entro 3 mesi** dall'inizio lavoro: scegli LAMal o CMI — confronta con il [comparatore](nav:health)
- **Conserva** tutti i certificati medici e le buste paga durante la malattia
- **Verifica** se il tuo datore ha l'assicurazione IJM (controlla la busta paga)
- **Conosci** i tuoi giorni di protezione dal licenziamento durante la malattia
- **Segnala** immediatamente ogni infortunio al datore (entro 3 giorni lavorativi)
- **Per malattie rare**: contatta il Centro dell'EOC a Bellinzona
- [Calcola il tuo stipendio netto](nav:calculator) per verificare che le deduzioni sanitarie siano corrette
- Cerca posizioni con **ottima copertura IJM** nella [bacheca lavoro](nav:job-board)`,"blog.article.malattia-frontaliere-guida-assicurazione.faq":`[{"q":"Qual è la copertura sanitaria obbligatoria per i lavoratori frontalieri in Svizzera?","a":"I lavoratori frontalieri in Svizzera devono avere un'assicurazione malattia. Le opzioni sono la LAMal svizzera o la CMI (Copertura Malattia per lavoratori Internazionali), che consente di restare nel Servizio Sanitario Nazionale italiano tramite deroga."},{"q":"Qual è il procedimento per cambiare da LAMal a CMI o viceversa dopo la scelta iniziale?","a":"Per cambiare da LAMal a CMI o viceversa dopo la scelta iniziale, è necessaria una procedura specifica. Il lavoratore deve giustificare il motivo del cambio (ad es., cambiamento delle esigenze sanitarie familiari) e presentare una richiesta formale all'autorità competente entro i tempi stabiliti (di solito entro 3 mesi da un evento significativo). La richiesta potrebbe richiedere la documentazione del nuovo stato (ad es., nascita di un figlio) e potrebbe essere soggetta a una valutazione caso per caso."},{"q":"Come funziona il rimborso delle spese sanitarie in caso di emergenza in Svizzera?","a":"Se si sceglie la LAMal, le cure in Svizzera sono coperte direttamente dall'assicurazione e si può usufruire di strutture svizzere senza liste d'attesa. Con la CMI, le cure in Svizzera sono coperte solo per emergenze e infortuni sul lavoro, e si può usufruire del sistema sanitario italiano per le cure ordinarie."}]`};export{a as default};
