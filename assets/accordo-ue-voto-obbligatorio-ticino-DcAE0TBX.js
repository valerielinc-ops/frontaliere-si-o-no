const e={"blog.article.accordo-ue-voto-obbligatorio-ticino.body1":`## En bref
- Tessin exige référendum obligatoire pour tout accord UE.
- Double majorité requise pour protéger souveraineté suisse.
- Accord 2.0 perçu comme menace à l'indépendance nationale.

## Faits clés
- **Cosa**: Motion UDC pour référendum obligatoire sur accords UE.
- **Quando**: Approuvé par le Grand Conseil tessinois en février 2026.
- **Qui**: Initiative des Jeunes UDC, soutenue par l'UDC tessinois.
- **Où**: Tessin, Suisse.
- **Impact**: Protection des mesures cantonales contre dumping salarial.
- **Craintes**: Reprise dynamique du droit UE et subordination à la CJUE.
- **Conséquences**: Risque de mesures de rétorsion de l'UE.
- **Objectif**: Garantir débat public avant tout changement d'époque.

Un signal politique fort et sans équivoque est envoyé de Bellinzone à Berne. Le Grand Conseil tessinois a approuvé une motion cruciale présentée par l'UDC visant à sanctuariser le processus de ratification de ce que l'on appelle l'« Accord-cadre 2.0 » avec l'Union européenne. La demande est claire : tout nouveau traité institutionnel avec Bruxelles devra être soumis à un référendum obligatoire avec la double majorité du Peuple et des Cantons.

Il ne s'agit pas d'un simple détail technique, mais d'une prise de position qui touche au cœur du fédéralisme suisse. La double majorité est requise pour les modifications constitutionnelles et pour l'adhésion à des organisations de sécurité collective ou à des communautés supranationales. L'appliquer à cet accord signifie l'élever au rang d'acte d'importance constitutionnelle, empêchant qu'une courte majorité d'électeurs puisse décider pour l'ensemble de la structure fédérale. Alain Bühler, chef du groupe UDC, a parlé d'un acte nécessaire « contre toute tentative de contourner la volonté populaire et de lier la Suisse à Bruxelles sans le consentement des Cantons ». La motion, initialement élaborée par les Jeunes UDC, charge désormais le Conseil d'État tessinois d'exercer une pression maximale sur les autorités fédérales pour faire respecter cette ligne.`,"blog.article.accordo-ue-voto-obbligatorio-ticino.body2":`Mais quelles sont les craintes concrètes qui ont poussé le parlement cantonal à faire ce pas ? L'UDC qualifie sans détour l'accord de « traité de soumission », une étiquette forte qui reflète des préoccupations profondes quant à la souveraineté nationale.

## Les points critiques de l'Accord 2.0

Les détracteurs de l'accord mettent en évidence trois piliers problématiques qui, selon eux, saperaient l'indépendance de la Suisse :
