const e={"blog.article.addizionale-irpef-mappa-comuni.body1":`## TL;DR
- IRPEF tax varies
- Municipal surcharge
- Residency impacts
...
📊 **Practical Example: 2026 Rates Compared**
A comparison of some border municipalities (indicative rates based on the latest available data):
- **Como (CO):** 0.8%
- **Varese (VA):** 0.8%
- **Lavena Ponte Tresa (VA):** 0.8%
- **Maslianico (CO):** 0.75%
- **Campione d'Italia (CO):** Special tax regime, does not apply the standard IRPEF surcharge.
- **Clivio (VA):** 0.6%

On a taxable IRPEF income of €40,000 (after the allowance and other deductions), the difference between residing in Como (€320) and Clivio (€240) is **€80** net per year. It may not seem like much, but on higher incomes and over an entire working life, the figure becomes significant.`,"blog.article.addizionale-irpef-mappa-comuni.body2":`## How the Calculation Works for New Cross-Border Workers
...
⚠️ **Timing is crucial:** To benefit from a specific municipality's rate for a tax year, you must have established your official residence there by **December 31st** of the previous year. A change of residence made on January 2, 2026, for example, will only have a fiscal effect starting from the 2027 tax period.`,"blog.article.addizionale-irpef-mappa-comuni.body3":`## Residency Strategies: More Than Just Taxes
...
Your choice of residence directly impacts your monthly net salary. Before making a decision, it's crucial to have a clear picture of your income and expenses. For a precise estimate of how the IRPEF surcharge and other factors will affect your paycheck, using simulation tools is advisable. Try our [Net Salary Calculator](nav:calculator) to compare different scenarios and make the most advantageous choice for you and your family.

*(Source: Frontaliere Ticino Editorial Staff, analysis of data from the Ministry of Economy and Finance for 2026)*`,"blog.article.addizionale-irpef-mappa-comuni.faq":'[{"q":"What is the difference between residing in Como and in Clivio if you have an IRPEF taxable income of 40,000 euros?","a":"The difference is 80 euros net per year, since in Como the additional municipal rate is 0.8%, while in Clivio it is 0.6%."}]'};export{e as default};
