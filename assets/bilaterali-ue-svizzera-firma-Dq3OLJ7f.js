const e={"blog.article.bilaterali-ue-svizzera-firma.body1":`## TL;DR
...
For the EU, this agreement is an essential piece for continental stability, especially in the current geopolitical climate. "Switzerland is an important partner. We share many values and interests, and it is in our mutual interest to cooperate, now more than ever," emphasized Jessica Rosenkranz, Swedish Minister for EU Affairs. However, the path in Switzerland is far from over. The government's message will reach the Federal Parliament in the coming weeks, kicking off what promises to be a heated debate. Although the agreement gained the support of the majority of cantons during the consultation phase, it is crucial to remember that **Ticino is not among them**. Our canton, along with others, expressed reservations, especially on hot-button issues like wage protection and immigration. The only party maintaining a firm and frontal opposition is the SVP (UDC), which calls the agreement a "submission treaty."`,"blog.article.bilaterali-ue-svizzera-firma.body2":`But what does this package actually contain, and what are the direct implications for the thousands of cross-border workers who cross the border every day? The architecture of the agreement is complex and touches on sensitive nerves of Ticino's economy.
...
⚠️ Open questions
Despite the green light from Brussels, the game will be played on the details of domestic implementation. Issues such as the protection of wages from downward pressure, the management of migration flows, and the methods for transposing EU law into Swiss law remain crucial sticking points. These will be the topics at the center of the parliamentary debate, where every comma can make a difference for the Ticino labor market.`,"blog.article.bilaterali-ue-svizzera-firma.body3":`With the signing in Brussels now on the horizon, the ball is entirely in Switzerland's court. The parliamentary debate will be just the first round of a contest that will likely culminate in a popular vote next year. The SVP has already sharpened its weapons to launch a referendum, turning the vote into a judgment on national independence and sovereignty.
...
In a scenario of potential change, having a clear understanding of one's own financial situation is more important than ever. Political dynamics and new agreements influence the labor market and, consequently, salaries. While politics defines the general framework, the most immediate impact for every worker remains on their payslip. To understand how these macroeconomic dynamics could affect your net income, it is essential to have a clear picture of your current situation. Use our [net salary calculator](nav:calculator) for a precise and up-to-date estimate based on current regulations.

*Source: RSI, 24.02.2026*`,"blog.article.bilaterali-ue-svizzera-firma.faq":`[{"q":"What are the key points of the new bilateral agreement package between Switzerland and the EU?","a":"The new package of bilateral agreements between Switzerland and the EU includes updating the Agreement on the Free Circulatory of People, new sectoral agreements on food security, health and electricity, a Swiss financial contribution to the economic and social cohesion of the EU and Switzerland's participation in EU programmes such as Horizon Europe and Erasmus+."},{"q":"How could the update of the Agreement on Free Circumulation of People (ALC) affect frontier workers?","a":"The updating of the ALC could lead to stricter regulations on worker mobility, improving the protection of wages and working conditions, especially if effective accompaniment measures will be taken."},{"q":"How could you change the regulation of residence permits for frontier workers with the new agreement?","a":"The new package could lead to a revision of the modes of release and renewal of residence permits, with possible stringent requirements or new categories of permits, thus affecting the ease of access to the Swiss labour market for frontier workers."}]`};export{e as default};
