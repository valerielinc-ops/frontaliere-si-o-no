const e={"blog.article.comuni-frontalieri-distanza.body1":`## TL;DR
- Misinto's 17km from Swiss border but not recognized as border municipality
...
- 72 new municipalities added to border list but still subject to double taxation

## Key facts
- **Distance Criteria**: 20 kilometers aerial distance from the border defines border municipalities
- **New Agreement Date**: July 17, 2023
- **New Municipalities**: 72 new municipalities added to the official list of border municipalities
- **Tax Status**: New cross-border workers subject to double taxation in Italy and Switzerland
...
The new 2023 agreement has finally set clearer rules, including 72 new municipalities in the official list of border municipalities. However, workers residing in these municipalities are considered 'new cross-border workers', regardless of their years of employment in Switzerland. This means that, compared to 'old cross-border workers', they are also subject to the Italian tax regime in addition to the Swiss one, significantly impacting their net income.

The issue has drawn criticism from unions, which have unsuccessfully demanded the application of retroactivity to ensure fairness. Andrea Puglia of OCST stated that 'there has been enormous confusion in the implementation of this agreement, which penalizes workers who have contributed to Ticino's economy for years'.

## Useful tools for your case
To verify your within/over 20 km tax scenario, use the [net salary calculator](nav:calculator) and the [tax return guide](nav:tax-return).`,"blog.article.comuni-frontalieri-distanza.body3":`## What to Do If Your Municipality Was Recently Added to the List?
...
💡 If you are unsure whether your municipality is included in the updated list, use our [Interactive Border Municipalities Map](nav:border-map) to precisely determine your tax situation. You can also use the [Net Salary Calculator](nav:calculator) to estimate the impact of the new agreement on your net income.

The case of Misinto demonstrates how important it is to stay informed about tax regulations and your rights as a cross-border worker. Don't let regulatory uncertainty compromise your earnings: stay informed, take action, and make use of the tools available to you. Source: tvsvizzera.it, February 28, 2026.`,"blog.article.comuni-frontalieri-distanza.faq":`[{"q":"What is the minimum distance to be considered a cross-border worker?","a":"According to the Italian Revenue Agency, to be considered a cross-border worker, it is necessary to reside in a commune less than 20 kilometers in line of air from the Swiss border."},{"q":"What is the tax impact for 'new frontierers' resident in border municipalities recently added to the list?","a":"The 'new frontierers' are subject to double taxation (Italy and Switzerland), without retroactivity for the lost benefits. They must manage both tax regimes, with net income impact."},{"q":"How can I check if my Municipality of residence has recently been recognized as a border municipality?","a":"You can consult the interactive map of the frontier municipalities available online or check with the Italian Revenue Agency, which has updated the official lists with the new Municipalities recognized in 2023."}]`};export{e as default};
