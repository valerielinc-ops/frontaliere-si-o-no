const e={"blog.article.riforma-giustizia-pace-ticino.body1":`## Auf einen Blick
...
> 'Die Modernisierung des Systems ist notwendig, um den heutigen und zukünftigen Herausforderungen der Tessiner Gesellschaft zu begegnen', erklärte der Staatsrat. Ziel ist es, einen öffentlichen Dienst zu erhalten, der in der Tradition verwurzelt ist, aber gleichzeitig effizienter und zeitgemäßer wird.`,"blog.article.riforma-giustizia-pace-ticino.body2":`## Auswirkungen auf die Grenzgänger und das Justizsystem
...
## Empfohlene Tools
Für eine aktuelle Schätzung nutzen Sie den [Nettolohnrechner](nav:calculator) und den [CHF-EUR-Wechselvergleich](nav:exchange).`,"blog.article.riforma-giustizia-pace-ticino.body3":`## Tipps für Grenzgänger
...
- Erkunden Sie die beruflichen Möglichkeiten im öffentlichen Sektor über unseren [Stellenvergleich](nav:jobs).

Für weitere Informationen zur Reform und zu den Möglichkeiten auf dem Tessiner Arbeitsmarkt besuchen Sie unseren [Netto-Lohnrechner](nav:calculator) und entdecken Sie, wie Sie Ihre beruflichen Perspektiven optimieren können.`,"blog.article.riforma-giustizia-pace-ticino.faq":'[{"q":"Wie wird sich die Figur des Friedensrichters im Justizsystem des Tessin verändern?","a":"Der Staatsrat hat eine Reform genehmigt, die die Modernisierung des Justizsystems vorsieht, mit einer Reduzierung der Justiz des Friedens von 38 auf 11 und der Einführung eines klaren Statuts für Friedensrichter mit einem gesetzlich geregelten Gehalt."},{"q":"Welche Auswirkungen wird die Reform der Friedensrichter auf die Arbeitsmöglichkeiten für grenzüberschreitende Arbeiter im Verwaltungssektor von Tessin haben?","a":"Die Reform könnte neue Arbeitsmöglichkeiten in einem zentralisierteren und stärker unterstützten System eröffnen, insbesondere für Rechtsassistenten und Verwaltungsangestellte, mit Schwerpunkt auf organisatorischen und digitalen Fähigkeiten."},{"q":"Wie wird sich die Reform auf die geografische Verteilung der Justizämter im Kanton Tessin auswirken?","a":"Die Reform wird die Zahl der Friedensrichter von 38 auf 11 reduzieren und ihre Aufgaben auf 11 Hauptstandorte, hauptsächlich in städtischen Gebieten, konzentrieren und so die Effizienz und Verwaltung der richterlichen Ressourcen auf dem Gebiet verbessern."}]'};export{e as default};
