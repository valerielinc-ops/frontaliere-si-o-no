const e={"blog.article.malattia-frontaliere-guida-assicurazione.body1":`## Auf einen Blick
...
- **Nettolohn berechnen:** Berücksichtigen Sie die Versicherungskosten bei der Gesamtkalkulation mit dem [Lohnrechner](nav:calculator)
- **Stellenangebote prüfen:** Achten Sie bei der Stellensuche auf Arbeitgeber mit guter KTG-Versicherung – recherchieren Sie in unserer [Jobbörse](nav:job-board)`,"blog.article.malattia-frontaliere-guida-assicurazione.faq":'[{"q":"Wie sieht die verpflichtende Krankenversicherung für Grenzarbeiter in der Schweiz aus?","a":"Grenzüberschreitende Arbeitnehmer in der Schweiz müssen eine Krankenversicherung haben. Die Optionen sind das Schweizer KVG oder das CMI (Health Coverage for International Workers), das es Ihnen ermöglicht, durch eine Befreiung im italienischen Nationalen Gesundheitsdienst zu bleiben."},{"q":"Wie läuft der Prozess ab, um nach der ersten Wahl von KVG zu CMI oder umgekehrt zu wechseln?","a":"Um nach der ersten Wahl von KVG zu CMI oder umgekehrt zu wechseln, ist ein spezielles Verfahren erforderlich. Der Arbeitnehmer muss den Grund für die Änderung (z. B. Änderungen der gesundheitlichen Bedürfnisse der Familie) begründen und innerhalb des festgelegten Zeitraums (in der Regel innerhalb von 3 Monaten nach einem bedeutenden Ereignis) einen formellen Antrag bei der zuständigen Behörde stellen. Der Antrag kann eine Dokumentation des neuen Status (z. B. Geburt eines Kindes) erfordern und kann einer Einzelfallbewertung unterliegen."},{"q":"Wie funktioniert die Erstattung der Gesundheitskosten im Notfall in der Schweiz?","a":"Wenn Sie sich für KVG entscheiden, wird die Behandlung in der Schweiz direkt von der Versicherung übernommen und Sie können Schweizer Einrichtungen ohne Wartelisten nutzen. Mit dem CMI wird die Behandlung in der Schweiz nur für Notfälle und Arbeitsunfälle abgedeckt, und Sie können das italienische Gesundheitssystem für die normale Versorgung nutzen."}]'};export{e as default};
