const e={"blog.article.truffa-falso-bancario-ticino.body1":`## TL;DR
...
(Source: Cantonal Police, 20.02.2026)`,"blog.article.truffa-falso-bancario-ticino.faq":`[{"q":"What is 'spoofing' and why is it dangerous for Switzerland-Italy cross-border commuters?","a":"'Spoofing' is a scam technique that masks the telephone identity by showing the number of a bank. It is dangerous because it tricks victims into revealing sensitive data, such as login credentials or security codes, putting accounts in Switzerland and Italy at risk."},{"q":"What is the specific risk for Switzerland-Italy cross-border commuters in connection with spoofing fraud?","a":"Cross-border commuters often manage accounts in both Switzerland and Italy, increasing the attack surface for criminals, who can exploit the complexity of accounts in two different jurisdictions."},{"q":"What should I do if I receive a WhatsApp or Telegram message that looks like it came from my Swiss or Italian bank?","a":"Do not reply or click on any links. Contact the bank only via the official number (website or back of the card) to verify the authenticity of the message. Scammers use logos and names of banks to deceive."},{"q":"How can I tell the difference between a fake and a real call from my bank?","a":"Banks never ask for credentials or codes over the phone. If the call seems urgent or threatens blockages, hang up and call the bank yourself with the official number. Spoofing can spoof the number as well."},{"q":"What bank details should I absolutely never share with anyone, not even with the bank on the phone?","a":"Never communicate passwords, OTP (SMS) codes, PINs, card details or push authorizations via phone, email or messages. The bank asks for them only through secure channels and never in an emergency."}]`};export{e as default};
